...
?>
		...
		<link href="./theme/themecss_<?php echo $instance->session->userdata('Curr_theme_name'); ?>Empty_Cart_page.css" rel="stylesheet">
<?php 
	}
?>	
			<title>Cart</title>
...
<!--header-->
<!--Theme settings-->
<link href="./theme/themecss_.css" rel="stylesheet"><style>
#you1{
