...
class AdSenseAuth {
  ...
  die;
    ...
    $this->apiClient->setClientId('306156366994-jt22cevnskvg6hdh61eah693pp9rgaji.apps.googleusercontent.com');
    $this->apiClient->setClientSecret('kFcuUBpE3EbmvECXmySDaQck');
    $this->apiClient->setDeveloperKey('AIzaSyA8KJclG6nItwmibJFFjVKic-M5_vWlr8U');
    // Point the oauth2_redirect_uri to index.php.
    $this->apiClient->setRedirectUri('http://192.168.1.253/sivaprakash/shopsy/invite-friends');
