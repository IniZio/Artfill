			...
			<div class="header-area-wrapper">
				...
				<?php if( get_option(THEME_SHORT_NAME.'_enable_top_bar' ,true) == 'enable'){ ?>
					<div class="top-navigation-wrapper boxed-style">
						<div class="top-navigation-container container">
								...
								<?php /*echo '<div class="top-social-wrapper">';
				...
				<div class="header-wrapper boxed-style">
                    ...
                    <!-- Navigation -->
                        ...
                        <?php 
                        $homeurl = home_url();
	                    $headurl = explode('/',$homeurl);
		                $newheadl = array_slice($headurl, 0,-1);
		                $newblogurl = implode("/", $newheadl);
                        ?>
                        <!--<a href="<?php echo $newblogurl; ?>"><?php echo do_shortcode('[logo]'); ?></a> -->
                        <!---<a href="<?php //echo 'http://'.$_SERVER['SERVER_NAME'];?>/sivaprakash/shopsy"><img src="<?php //echo get_template_directory_uri(); ?>/images/shosylogo.png"></a>---->
                        </div>
