...
<base href="<?php echo $base_path; ?>" />
			...
			<title>admin Favorites on Shopsy V2</title>
...
?>
		<link href="./theme/themecss_<?php echo $instance->session->userdata('Curr_theme_name'); ?>Favorite-page.css" rel="stylesheet">
				 ...
				 <div class="col-md-2 pull-right signin cart-top">  
						<!--<i class="fa fa-bell"></i>-->
						 <span class="shop-cart"> 
						     ...
						     <a class="cart-txt" href="cart">Cart							<span id="CartCount1" class="CartCount1"> 1</span>
							 </a> 
						</span>
					 </div>
...
<section class="container">
	...
	<ul class="bread_crumbs">
            ...
            <span>&rsaquo;</span>
           <li><a href="view-profile/admin" class="a_links">admin</a></li>
		    <span>&rsaquo;</span>
	...
	<div class="avatar_menu">
        ...
        <img class="fav-avatar" width="75" height="75" alt="avatar" src="images/theme/9002.jpg">
        ...
        <ul class="owner-fav">
        	...
        	<li>
                ...
                <a href="people/admin/followers">

                    <span class="fav-number">1</span>

                    <span class="fav-name"> Followers </span>
            ...
            <li>
                ...
                <a href="people/admin/following">

                    <span class="fav-number">3</span>

                    <span class="fav-name"> Following </span>
	...
	<div style="float:left; width:100%;" class="favorite favorite_box1">
		...
		<div class="main">    
      		...
      		<div class="top_list" style="width:95%;">
                ...
                <a class="title-head2" href="http://192.168.1.251:8081/shopsy-v2/people/admin/favorites"> admin's Favorites </a>

                <form method="get">

                <input name="a" id="a" class="input-forms" type="text" value="" placeholder="Search available items">
                ...
                <ul style="width:auto;" class="listtypename">
                    ...
                    <li class="first_list first_list_seleted">
                        ...
                        <a class="top_first_line " href="people/admin/favorites"> Items </a>

                    </li>

                    <li class="first_list2">

                        <a class="top_first_line" href="people/admin/favorites/shop"> Shop </a>

                    </li>

                    <!--<li class="first_list3">

                        <a class="top_first_line" href="people/admin/favorites/treasuries/"> Treasuries </a>
            ...
            <ul class="collection_fav">
                ...
                <li>
                   ...
                   <a href="people/admin/favorites/items-i-love" class="fav_list_img">

                       <div class="image_collection">

                       
                       		
                           <img src="images/theme/1434604748-906235400463320592_0cb744a7a29d.jpg" alt="LED Shoes by Electric Styles "/>

                           
                           <img src="images/theme/1434697883-chrysanthemum.jpg" alt="tes-bg"/>

                           
                           <img src="images/theme/1435745954-1429593492.jpg" alt="dd"/>

                           
                           <img src="images/theme/1435754405-81hv9bhadrl._UY679__1" alt="ddSS"/>

                           
                           <div class="fav_num"><span> 8 </span></div>
                       ...
                       <div class="fav-detail">
                           ...
                           <h3>
                            ...
                            <span class="fav-text">Items I Love</span>

                           </h3>

                           <p class="fav-item"> 8 items </p>
                ...
                <li>
                    ...
                    <div class="fav-link" id="create_list" style="display:none;">
                    	...
                    	<form method="post" action="site/user/add_list">
                        	...
                        	<input type="text" name="list" id="list" placeholder="List name" />

                            <input type="submit" class="primary-button" value="Create" />
						...
						<div class="footer_tab_content">
							...
							<span id="selectedCurrency">RS Indian Rupee</span>
								...
								<div class="btn-group">
									...
									<input type="hidden" name="returnUrl" value="http://192.168.1.251:8081/shopsy-v2/people/admin/favorites">
