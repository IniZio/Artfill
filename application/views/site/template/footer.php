  ...
  <footer class="container"><!--
    <div class="row">
      <div class="col-md-3 footer-block"> 
		<?php if($shopProduc == 0){ ?>
		<span class="footer-head no-ul"><?php //if($this->lang->line('footer_business') != '') { echo stripslashes($this->lang->line('footer_business')); } else echo 'Turn Your Passion Into a Business';?></span>
        <a href="shop/sell"><div class="search-bt col-md-6 col-xs-4 op-bt"><?php //if($this->lang->line('footer_open_a_shop') != '') { echo stripslashes($this->lang->line('footer_open_a_shop')); } else echo 'Open a Shop';?></div></a>
		<?php } ?>
		
		<span class="footer-head"><?php //if($this->lang->line('footer_sell_on') != '') { echo stripslashes($this->lang->line('footer_sell_on')); } else echo 'Sell on';?> <?php echo $this->config->item('email_title'); ?></span>
		
        <ul class="footer-list">
          
          <li><a href="find/shop"><?php //if($this->lang->line('footer_browse_all_shops') != '') { echo stripslashes($this->lang->line('footer_browse_all_shops')); } else echo 'Browse all shops';?></a></li>
			<li><a href="shop-by-location"><?php //if($this->lang->line('footer_search_shops') != '') { echo stripslashes($this->lang->line('footer_search_shops')); } else echo 'Search by Location';?></a></li>
        </ul>
      </div>-->
<?php
// adding chinese footer translations Kethen was here 25/1/2016 
	    if($this->_ci_cached_vars["languageCode"] == "en"){
	    	    //echo stripcslashes($this->config->item('footer_widget1'));
	    	    //echo stripcslashes($this->config->item('footer_widget2'));
	    	    //echo stripcslashes($this->config->item('footer_widget3'));
	    	    //echo stripcslashes($this->config->item('footer_widget4'));
?>
    ...
    <div class="row">
      ...
      <div class="col-md-4 footer-block"style="padding:0px;"> 
        <ul class="footer-list">
		<li><a href="" > Shopping Guide</li>
	   ...
	   <div class="col-md-4  footer-block">
		<ul class="footer-list">
		<li><a href="community">資料查詢</a></li>
		<li><a href="teams">常見問題</a></li>
		<li><a href="events">關於送貨</a></li>
		<li><a href="events">關於退貨</a></li>
		<li><a href="events">訂單追踨</a></li>
		</ul>

	</div>
		  <div class="col-md-4  footer-block">
		<ul class="footer-list">
		<li><a href="community">關於我們</a></li>
		<li><a href="teams">公司資料</a></li>
		<li><a href="events">商店加盟</a></li>
		<li><a href="events">使用條款</a></li>
...
?>
    ...
    <div class="row">
      ...
      <div class="col-md-4 footer-block"style="padding:0px;"> 
		<?php if($shopProduc == 0){ ?>
		<!--<span class="footer-head no-ul"><?php if($this->lang->line('footer_business') != '') { echo stripslashes($this->lang->line('footer_business')); } else echo '';?></span>-->
        <!--<a href="shop/sell"><div class="search-bt col-md-6 col-xs-4 op-bt"><?php if($this->lang->line('footer_open_a_shop') != '') { echo stripslashes($this->lang->line('footer_open_a_shop')); } else echo 'Open a Shop';?></div></a>-->
		<!--<img src="./img/artfill_logo.png">-->
		<?php } ?>
		
		<!--<span class="footer-head"><?php if($this->lang->line('footer_sell_on') != '') { echo stripslashes($this->lang->line('footer_sell_on')); } else echo 'Sell on';?> <?php echo $this->config->item('email_title'); ?></span>-->
		<!--<span class="footer-head">購物指南</span>-->
        <ul class="footer-list">
	    ...
	    <?php //echo stripcslashes($this->config->item('footer_widget1')); ?>
		<?php //echo stripcslashes($this->config->item('footer_widget2')); ?>
		<?php //echo stripcslashes($this->config->item('footer_widget3')); ?>
	    <?php //echo stripcslashes($this->config->item('footer_widget4')); ?>
	  <div class="col-md-4  footer-block">
		<ul class="footer-list">
		<li><a href="community">資料查詢</a></li>
		<li><a href="teams">常見問題</a></li>
...
<div class="col-md-2 footer-block"><span class="footer-head">到處逛逛</span> 
<ul class="footer-list">
<li><a href="gift-cards">禮物卡</a></li>
</ul>
<span class="footer-head no-ul">加入我們Artfill的社區</span>
<ul class="footer-list">
<li><a href="community">Artfill社區</a></li>
<li><a href="teams">團隊</a></li>
<li><a href="events">即將舉辦的活動</a></li>
</ul>
<p>&nbsp;</p>
<ul class="footer-list">
</ul>
...
<div class="col-md-2 footer-block"><span class="footer-head">了解我們</span> 
<ul class="footer-list">
<li><a href="pages/about-us">關於Artfill</a></li>
<li><a href="pages/careers">事業</a></li>
<li><a href="pages/contact-us">聯絡我們</a></li>
</ul>
</div>

<div class="col-md-2 footer-block"><span class="footer-head">關注Artfill</span> 
<ul class="footer-list">
...
?>
	...
	-->
      ...
      <a href="pages/help"><div class="help-bt"><?php if($this->lang->line('footer_help') != '') { echo stripslashes($this->lang->line('footer_help')); } else echo 'Help';?></div></a>
    
	</div>

    <ul class="bt-menu">
      <li id="copy"> <?php echo stripslashes($this->config->item('footer_content')); ?></li>
      <li><a href="pages/privacy-policy"><?php if($this->lang->line('user_privacy_policy') != '') { echo stripslashes($this->lang->line('user_privacy_policy')); } else echo 'Privacy';?></a></li>
   </ul>
	-->
</div>
<br/>
...
<?php } ?>
	<img style="width:30px;"src="./images/Facebook-64.png"/> &emsp; 
	<img style="width:30px;" src="./images/Instagram-64.png"/> &emsp; 
	<img style="width:30px;" src="./images/Youtube-64.png"/> 
</div>
</div>
  </footer>
  
  <hr style="background-color: #66f4cf; width:100%;"/>
	<div class="container">
	<div class="row">
	<div class="col-md-12">
...
<h5><?php if($this->lang->line('lg_preferences_saved') != '') { echo stripslashes($this->lang->line('lg_preferences_saved')); } else echo "Your preferences have been saved. You can always update these regional and currency settings later at the bottom of any page."; ?>.</h5>
<h3><?php if($this->lang->line('lg_preferences_reload') != '') { echo stripslashes($this->lang->line('lg_preferences_reload')); } else echo "Your Changes can be seen on Reload."; ?></h3>
</div>

<div class="regional-setting-right">
<input class="ok-button"  onclick="getReloadVal(1);" value="<?php if($this->lang->line('lg_reload') != '') { echo stripslashes($this->lang->line('lg_reload')); } else echo "Reload"; ?>" type="button">
<input class="canceling-button3" onClick="getReloadVal(2);" value="<?php if($this->lang->line('land_nothanks') != '') { echo stripslashes($this->lang->line('land_nothanks')); } else echo "No thanks"; ?>" type="button">
</div>
</div>
</div>
