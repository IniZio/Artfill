<?php 
$this->load->view('site/template/commonheader');
...
<style>
#you1{
	background-image:url("<?php echo base_url()."image/".$user_pic; ?>");
...
<!-- header_start -->
 ...
 <div class="header_top" style="position:relative;">
		...
		<?php if($this->session->userdata['artfill_session_user_name'] == ''){?>
			<div class="container top">
				<div class="row" style="padding-bottom:30px;magrin-bottom:30px;">
				    <div class="col-md-12 signin sign-mobile"> 
					     <a href="register"><?php if($this->lang->line('headind_register') != '') { echo stripslashes($this->lang->line('headind_register')); } else echo 'Register'; ?></a> | <a href="login"><?php if($this->lang->line('headind_sign_in') != '') { echo stripslashes($this->lang->line('headind_sign_in')); } else echo 'Sign in'; ?></a>
						 
						 <span class="shop-cart"> 
						<a href="cart" title =" Cart"><i class="fa fa-shopping-cart"></i><?php if($this->lang->line('heading_cart') != '') { echo stripslashes($this->lang->line('heading_cart')); } else echo 'Cart';?>
					...
					<!--new elements-->
					<div>
						<a href="<?php echo base_url();?>" title="<?php echo 'Home'; ?>"><span style="color:white;">首頁</span></a>
						<span style="color:white;">&emsp;|&emsp;</span>
						<a href="pages/about-us"><span style="color:white;">關於我們</span></a>
						<span style="color:white;">&emsp;|&emsp;</span>
						<a><span style="color:white;">常見問題</span></a>
						<span style="color:white;">&emsp;|&emsp;</span>
						<a><span style="color:white;">購物指南</span></a>
						...
						<img src="./image/eng.png" style="width:30px;" />
						</a>
					</div>
					
					<div style="text-align:center;width:100%;padding-top:20px;">
						<a href="."><img src="./image/header_logo.png" style="width:25%;" /></a>
					</div>
					...
					<div style="width:100%;padding-bottom:20px;">
						<div class="col-xs-6 col-sm-3 header-menu" style="text-align:center;">
							<div style="width:100%;padding-bottom:2px;" >
								<div style="">
								<span style="padding:5px;font-size:120%;">時裝美容</span>
								</div>
							</div>
						</div>
						<div class="col-xs-6 col-sm-3 header-menu" style="text-align:center;">
							<div style="width:100%;padding-bottom:2px;" >
								<div style="">
								<span style="padding:5px;font-size:120%;">生活家居</span>
								</div>
							</div>
						</div>
						<div class="col-xs-6 col-sm-3 header-menu" style="text-align:center;">
							<div style="width:100%;padding-bottom:2px;" >
								<div style="">
								<span style="padding:5px;font-size:120%;">100元內筍價</span>
								</div>
							</div>
						</div>
						<div class="col-xs-6 col-sm-3 header-menu" style="text-align:center;">
							<div style="width:100%;padding-bottom:2px;" >
								<div style="">
								<span style="padding:5px;font-size:120%;">度身訂造</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-2 col-xs-2" id="logo">  
						<a href="<?php echo base_url(); ?>">
							<img src="image/logo/<?php echo $this->config->item('logo_image'); ?>" alt="<?php echo $this->config->item('email_title'); ?>" title="<?php echo $this->config->item('email_title'); ?>" />
						</a>
					</div>				 
					<div class="col-md-3 search-bl col-xs-6">				
						<form name="search" action="search/all" method="get">
							...
							<input type="submit" value="<?php echo 'Search';?>" class="search-bt">			
						</form>
						<div id="sugglist"></div>
					</div>
				...
				<?php }?>					
                      <div class="col-md-2 pull-right signin cart-top">
						  ...
						  <span class="shop-cart"> 
							...
							<a class="cart-txt" href="cart" title="Cart">
								<?php if($this->lang->line('comm_cart') != '') { echo stripslashes($this->lang->line('comm_cart')); } else echo 'Cart'; ?> 
								<span id="CartCount1" class="CartCount1"> <?php if($MiniCartViewSet>0) { ?><?php echo $MiniCartViewSet; ?><?php }else{ echo '0'; } ?></span>
							</a>
							</span> 
					...
					<div class="col-md-5 col-xs-5 top-login"> 				
						<ul class="header_menu">
							<li>
								<a href="<?php echo base_url();?>" id="home" title="<?php echo 'Home'; ?>">
									<span class="icon-text"><?php if($this->lang->line('landing_home') != '') { echo stripslashes($this->lang->line('landing_home')); } else echo 'Home'; ?></span>
								</a>
							</li>					
							<li>
								<a href="shop/sell" id="shop" title="<?php echo 'You Shop'; ?>">
									<span class="icon-text"><?php if($this->lang->line('header_shop') != '') { echo stripslashes($this->lang->line('header_shop')); } else echo 'Shop';?></span>
							...
							<li>
								...
								<span class="icon-text"><?php if($this->lang->line('header_search_shops') != '') { echo stripslashes($this->lang->line('header_search_shops')); } else echo 'By Location';?></span>															
								</a>
							...
							<li>
								...
								<a id="register" href="register"><span class="icon-text"><?php if($this->lang->line('user_register') != '') { echo stripslashes($this->lang->line('user_register')); } else echo 'Register'; ?></span></a>
							...
							<li>
								...
								<a id="signin-icon" href="login"><span class="icon-text"><?php if($this->lang->line('user_signin') != '') { echo stripslashes($this->lang->line('user_signin')); } else echo 'Sign In'; ?></span></a>
							...
							<li>
								...
								<a id="register" data-toggle="modal" href="#signin" onclick="javascript:$('#registerTab').trigger('click');"><span class="icon-text"><?php if($this->lang->line('user_register') != '') { echo stripslashes($this->lang->line('user_register')); } else echo 'Register'; ?></span></a>
							...
							<li>
								...
								<a id="signin-icon" data-toggle="modal" href="#signin" onclick="javascript:$('#loginTab').trigger('click');"><span class="icon-text"><?php if($this->lang->line('user_signin') != '') { echo stripslashes($this->lang->line('user_signin')); } else echo 'Sign In'; ?></span></a>
					  ...
					  <!--<?php if($this->uri->segment(1) == 'register' || $this->uri->segment(1) == 'login') {?>
						  <a  href="register"><?php if($this->lang->line('user_register') != '') { echo stripslashes($this->lang->line('user_register')); } else echo 'Register'; ?></a> <span class="btn">
					     <a  href="login"><?php if($this->lang->line('user_signin') != '') { echo stripslashes($this->lang->line('user_signin')); } else echo 'Sign In'; ?></a></span> 
					  <?php } else {?>
					     <a data-toggle="modal" href="#signin" onclick="javascript:$('#registerTab').trigger('click');"><?php if($this->lang->line('user_register') != '') { echo stripslashes($this->lang->line('user_register')); } else echo 'Register'; ?></a> <span class="btn">
					     <a data-toggle="modal" href="#signin" onclick="javascript:$('#loginTab').trigger('click');"><?php if($this->lang->line('user_signin') != '') { echo stripslashes($this->lang->line('user_signin')); } else echo 'Sign In'; ?></a></span> 
					  <?php }?>-->
		...
		<?php } 
			 ...
			 <div class="container top">
				...
				<div class="col-md-12 signin sign-mobile"> 					
						<span class="shop-cart" > 
							<a href="cart" title ="cart"><i class="fa fa-shopping-cart icon-shopping"></i> <?php if($this->lang->line('comm_cart') != '') { echo stripslashes($this->lang->line('comm_cart')); } else echo 'Cart'; ?> 
							<span id="CartCount1" class="CartCount1"> <?php if($MiniCartViewSet>0) { ?><?php echo $MiniCartViewSet; ?><?php }else{ echo '0'; } ?></span>
						</a>
						</span>
				</div>
				   ...
				   <div class="col-md-3 search-bl col-xs-6 ">				
						<form name="search" action="search/all" method="get">
							...
							<?php if($shipVal != ''){ ?>
							<input type="hidden" name="shipto" value="<?php echo $shipVal;?>" /> <?php  }?>						
							<input type="submit" value="<?php if($this->lang->line('heading_search') != '') { echo stripslashes($this->lang->line('heading_search')); } else echo 'Search'; ?>" class="search-bt">			
						</form>
						<div id="sugglist"></div>
				  </div>
				...
				<?php if($this->config->item('mega_menu') == 'No'){?>
				 <div class="btn-group col-md-1 act-browse-bt col-xs-6">
					<button type="button" class="btn btn-default dropdown-toggle browse " data-toggle="dropdown" aria-expanded="false"> <?php if($this->lang->line('heading_browse') != '') { echo stripslashes($this->lang->line('heading_browse')); } else echo 'Browse'; ?>
						<span class="caret"></span> 
					</button>
							<ul class="dropdown-menu" role="menu">
							...
							<?php 
								...
								<li><a href="<?php echo base_url().'category'; ?>"><?php echo $recentFavorites[0]['full_name']; ?> <em><?php if($this->lang->line('com_more') != '') { echo stripslashes($this->lang->line('com_more')); } else echo "More"; ?></a></li>
				 ...
				 <div class="col-md-2 pull-right signin cart-top">  
						<!--<i class="fa fa-bell"></i>-->
						 <span class="shop-cart"> 
						     <a href="cart" title="cart"><i class="fa fa-shopping-cart icon-shopping"></i> </a>
						     <a class="cart-txt" href="cart"><?php if($this->lang->line('heading_cart') != '') { echo stripslashes($this->lang->line('heading_cart')); } else echo 'Cart';?>
							<span id="CartCount1" class="CartCount1"> <?php if($MiniCartViewSet>0) { ?><?php echo $MiniCartViewSet; ?><?php }else{ echo '0'; } ?></span>
							 </a> 
						</span>
					 </div>
				    ...
				    <div class="col-md-5 col-xs-5 top-login">
						...
						<ul class="header_menu">
							...
							<li>
								<a href="<?php echo base_url();?>home" id="home" title="<?php echo 'Home';?>">
									<span class="icon-text"><?php if($this->lang->line('landing_home') != '') { echo stripslashes($this->lang->line('landing_home')); } else echo 'Home'; ?></span>
								</a>
							</li>
							
							<li>
								<a id="favorites" href="people/<?php echo $this->session->userdata['shopsy_session_user_name'];?>/favorites" title="<?php echo 'Favorites'; ?>">
									<span class="icon-text"><?php if($this->lang->line('landing_favorites') != '') { echo stripslashes($this->lang->line('landing_favorites')); } else echo 'Favorites'; ?></span>
								</a>
							</li>
							...
							<li>
								<a href="shop/sell" id="shop" title="<?php echo 'You Shop'; ?>">
									...
									<span class="icon-text"><?php if($this->lang->line('landing_your_shop') != '') { echo stripslashes($this->lang->line('landing_your_shop')); } else echo 'Your Shop'; ?></span>
									<?php } else{?>
									<span class="icon-text"><?php if($this->lang->line('landing_sell') != '') { echo stripslashes($this->lang->line('landing_sell')); } else echo 'Sell';?></span>
									<?php }?>
								</a>
							...
							<li>
										<!--<div class="drop_right_main">
											<div class="user_img">
												<img src="image/default_avat.png">
											</div>
								...
								<a class="dropdown-toggle browse "  data-toggle="dropdown" id="you1" title="<?php echo 'You'; ?>">
								...
								<ul class="dropdown-menu browse-nav-inner showlist2" role="you">
									 ...
									 <li class="first">
										<div class="drop_right_main">
											...
											?>
											<img src="image/<?php echo $user_pic;?>" />
											</div>
											
											<!-- <div class="drop_right"><strong><?php echo $this->session->userdata['shopsy_session_user_name'];?></strong><span><a href="view-profile/<?php echo $this->session->userdata['shopsy_session_user_name']; ?>" class="view-btn1"><?php if($this->lang->line('landing_view_profile') != '') { echo stripslashes($this->lang->line('landing_view_profile')); } else echo 'View Profile';?></a></span></div> -->							
											<div class="drop_right"><strong><?php echo $this->session->userdata['shopsy_session_user_name'];?></strong><span><a href="public-profile" class="view-btn1"><?php if($this->lang->line('landing_view_profile') != '') { echo stripslashes($this->lang->line('landing_view_profile')); } else echo 'View Profile';?></a></span></div>							
										</div>
									</li>
		...
		<div class="header_top header_fixed_menu" style="background-image:none;position:relative;">
				...
				<div class="row">
					...
					<div class="col-md-4 search-bl col-xs-4">	
						<div class="col-md-12 col-xs-12">
						<span style="color:#8dbad4; font-weight: bold;font-size:150%;">分類</span>
						<form name="search" action="search/all" method="get">
							<input type="text" class="search" name="item" placeholder="<?php if($this->lang->line('temp_srchitems') != '') { echo stripslashes($this->lang->line('temp_srchitems')); } else echo 'Search for items and shops'; ?>" value="<?php if($this->input->get('item') != ''){ echo htmlspecialchars($this->input->get('item'));}?>" id="search_items" autocomplete="off" >
							<?php if($this->input->get('gift_cards') == 'on'){ ?>
							<input type="hidden" name="gift_cards" value="<?php echo $gift;?>" /> <?php  }?>
							...
							<?php if($shipVal != ''){ ?>
							<input type="hidden" name="shipto" value="<?php echo $shipVal;?>" /> <?php  }?>						
							<input type="submit" value="      " class="search-bt" style="color:white;background-image:url('./image/magnifier.png');background-size: 70%;background-repeat: no-repeat;" />
						</form>
						</div>
						<div id="sugglist"></div>
					</div>
				...
				<style>
					.hot{
						color:#c8b0b0;
						font-size:120%;
						border-bottom:thin dashed #c8b0b0;;
					}
				</style>
						<div class="col-md-4" style="text-align: left;">
							<span style="color:#c5c6c6; font-weight: bold;font-size:150%;">熱門搜尋﹕</span>
					...
					<div class="col-md-2 col-xs-2 top-login"> 				
						<ul class="header_menu">
						<!--
							<li>
								<a href="<?php echo base_url();?>" id="home" title="<?php echo 'Home'; ?>">
						...
						-->
							...
							<?php if($this->uri->segment(1) == 'register' || $this->uri->segment(1) == 'login') {?>
							<li>
								<a data-toggle="modal" href="#signin" onclick="javascript:$('#loginTab').trigger('click');"><img src="./image/user-silhouette.png" style="width:20px;" /><span style=" font-weight: bold;font-size:120%;margin-top:10px;">你好，XXX</span></a>	
							</li>
							<?php } else {?>
							<li>
								<a data-toggle="modal" href="#signin" onclick="javascript:$('#loginTab').trigger('click');"><img src="./image/shape.png" style="width:20px;" /><span style=" font-weight: bold;font-size:120%;margin-top:10px;">登入</span></a>	
							</li>
							
							<li>	
								<a data-toggle="modal" href="#signin" onclick="javascript:$('#registerTab').trigger('click');"><img src="./image/notes.png" style="width:20px;" /><span style=" font-weight: bold;font-size:120%;margin-top:10px;">註冊</span></a>
							</li>
							<?php }?>
							...
							<a class="cart-txt" href="cart" title="Cart">
							<img src="./image/commerce.png" style="width:20px;" /><span style=" font-weight: bold;font-size:120%;margin-top:10px;">購物車</span>
								<span id="CartCount1" class="CartCount1"> <?php if($MiniCartViewSet>0) { ?><?php echo $MiniCartViewSet; ?><?php }else{ echo '0'; } ?></span>
							</a>
							</li>
	...
	<?php
		...
		<?php 
			...
			<?php if ($keysLength >= 10){?>
				...
				<div class="col-md-4 col-sm-6 col-xs-12"> <img src="image/category/<?php echo $catImg;?>" alt="" class="img-responsive"> </div>
			<?php } else{?>
				<div class="col-md-4 col-sm-6 col-xs-12"> <img src="image/category/<?php echo $catImg;?>" alt="" class="img-responsive"> </div>
			<?php } ?>
		</div>
...
<?php } ?>
		<?php if($this->uri->segment(1) == ''){?>	
			<?php 
			$image_name="image/landingbanner/banner-admin.jpg";  
			if($banner_settings->row()->status == 'Active'){
				if($bannerSlide_image[0]['image'] != ''){
					$image_name='image/landingbanner/'.$bannerSlide_image[0]['image'];
				}		
			} else {
				if($recentFavorites[0]['seller_banner'] != ''){
					$image_name = 'image/banner/'.$recentFavorites[0]['seller_banner'];
				} 
			}
			...
			?>
			 ...
			 <!--<div class="jumbotron hero" <?php if($recentFavorites[0]['seller_banner']!=''){ ?>style="background-image:url(image/banner/<?php echo $recentFavorites[0]['seller_banner']; ?>)" <?php } ?>>-->
				  
			<div class="jumbotron hero" style="margin-top:350px;" > 
					...
					<?php $i=0;	foreach($sliderslist->result() as $sliders)
						...
						<div class="item <?php if($i == 0){ echo 'active'; } ?>">
									...
									<div class=" container hero-in hero-in-1">
									  <div class="container">
									  <div class="col-md-7" style="padding-left: 78px;color:#c5c6c6;">
									  ...
									  { ?>
										...
										<a class="banner-bt" href="<?php echo trim( prep_url( $sliders->link));?>" target="_blank" /><?php echo 'Read More';?></a> <?php } ?>
						...
						<img src="image/sliders/<?php echo $sliders->image;?>" /> <?php } ?>
				...
				<!--<div class="image-credit-wrap">
				  <div class="container">					
					...
					?>
						<img class="img-circle" alt="<?php echo $recentFavorites[0]['full_name']; ?>" src="image/<?php if($recentFavorites[0]['thumbnail']!=''){ echo 'users/thumb/'.$recentFavorites[0]['thumbnail']; }else{ echo 'default_avat.png';} ?>">
					...
					<div class="banner-user-profile">
					 ...
					 <?php if(count($FavoriteShopsProducts[$FavShops[0]])>4){ $cnt=4;}else{$cnt=count($FavoriteShopsProducts[$FavShops[0]]);} 
					  ...
					  for($l=0;$l<$cnt;$l++){  ?>
						...
						if($img[0] != ''){
							$img_src='image/product/list-image/'.$img[0];
						} else {
							$img_src='image/noimage.jpg';
						}
						?>      
						<div class="rf-small"> 
					  ...
					  <div class="rf-small">
						<a href="shop-section/<?php echo $recentFavorites[0]['shop_seourl']; ?>" class="shop-listing-count"> <span class="listing-count"><?php echo count($FavoriteShopsProducts[$FavShops[0]]); ?> </span><?php if($this->lang->line('shop_items') != '') { echo stripslashes($this->lang->line('shop_items')); } else echo 'items'; ?>  
						</a>
	...
	<div class="col-md-4 search-bl col-xs-12 hidesearch">
		<div class="hidesearch-cover">
			<form name="search" action="search/all" method="get">
				<input type="text" class="search" name="item" placeholder="<?php if($this->lang->line('temp_srchitems') != '') { echo stripslashes($this->lang->line('temp_srchitems')); } else echo 'Search for items and shops'; ?>" value="<?php if($this->input->get('item') != ''){ echo $this->input->get('item');}?>" id="search_items" autocomplete="off" >
				<?php if($this->input->get('gift_cards') == 'on'){ ?>
				<input type="hidden" name="gift_cards" value="<?php echo $gift;?>" /> <?php  }?>
				 <?php if($minVal != ''){ ?> 
				<input type="hidden" name="min_price" value="<?php echo $minVal;?>" /> <?php  }?>
				...
				<?php if($shipVal != ''){ ?>
				<input type="hidden" name="shipto" value="<?php echo $shipVal;?>" /> <?php  }?>
				<input type="submit" class="search-bt" value="<?php if($this->lang->line('heading_browse') != '') { echo stripslashes($this->lang->line('heading_browse')); } else echo 'Browse'; ?>" />
				<div id="sugglist"></div>
			</form>
		</div>
	</div>
