		...
		<section>
			...
			<div class="shipping_address">
					<div class="main">		
						...
						<div class="payment-success"><img src="<?php echo base_url(); ?>css/default/mobile/images/failed.png" alt="failed" title="failed" /></div>
					</div>			
					</div>	
			</div>
			<?php $this->output->set_header('refresh:2;url='.base_url().'mobile/payment/pay-failed?mobileId='.$mobileId); ?>
		</section>
	</body>
</html>
