            ...
            <div class="feedback_rating">
                 ...
                 <div class="rating-text">
					...
					<input type="hidden" name="store_name" id="store_name" value="<?php echo $userVal[0]['seller_businessname'];?>" />	
						...
						<input type="hidden" name="seller_shop_id" id="seller_shop_id" value="<?php echo $userVal[0]['id'];?>" />	
...
<br />
        ...
        <div class="popup_login" style=" margin-left:10px;width:24%; float:right; ">
                 ...
                 <?php if($userpersonalVal[0]['thumbnail']!=''){ ?>  

                <a href="#"><img src="<?php echo USERIMAGEPATH.$userpersonalVal[0]['thumbnail']; ?>" width="80px" height="110px"/></a>

                                <?php }else{ ?>  <img src ="images/noimage.jpg" value= "" alt="No Image" width="80px" height="110px" /> <?php } ?>



                <div class="clear"></div>

                <span style="width:75%;"><a href="store/<?php echo $userVal[0]['seller_id']; ?>-<?php echo strtolower(url_title($userVal[0]['seourl'],true)); ?>"><?php echo $userpersonalVal[0]['full_name']; ?></a> </span>
