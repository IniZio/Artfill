...
<div id="sell-on-header">
  ...
  <p class="create-shop-wrap "><a href="login?action=shop/sell" class="shopsy_shop"><?php echo artfill_lg('lg_open_an','Open an');?> <?php echo ucfirst($this->config->item('email_title')); ?> <?php if($this->lang->line('user_list_shop') != '') { echo stripslashes($this->lang->line('user_list_shop')); } else echo 'Shop'; ?></a></p>
...
<!--
  <div class="container">
		...
		<ul class="bread_crumbs">
            ...
            <span>&rsaquo;</span>
		   <li><?php echo artfill_lg('lg_open_new_shop','Open new shop');?></li>
        </ul>
