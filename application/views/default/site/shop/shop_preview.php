                ...
                <div class="shop_view_right">
                    ...
                    <div id="shop-info" class="shopview_info">
                    	...
                    	<ul>
							...
							<li style="margin-left:450px;"><input type="checkbox" name="gcardaccept" id="gcardaccept" value="yes" <?php if($selectSeller_details[0]['gift_card'] == 'Yes') {echo 'checked';} ?> onchange="valchecked(this);"> <?php echo shopsy_lg('lg_accept_gift_card',' Accept Gift Card');?></li>
                        </ul>
