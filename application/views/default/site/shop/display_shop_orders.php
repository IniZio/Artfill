...
<div class="purchase_review community_right">     					
			...
			<div class="all-purchase-search">
                ...
                <ul style="width:auto;" class="listtypename">
				   ...
				   <li><a title="" href="shops/<?php echo $selectSellershop_details[0]['seourl']; ?>/shop-orders" class="" ><div class="name-inner"><?php echo "所有交易";?> <span class="suborder"><?php if($_GET['order']=='' && $orderList->num_rows > 0){ echo $orderList->num_rows; }?></span> </div></a></li>
				   <li><a title="" href="shops/<?php echo $selectSellershop_details[0]['seourl']; ?>/shop-orders?order=Processed" class="" ><div class="name-inner"><?php echo "已處理";?> <span class="suborder"><?php if($_GET['order']=='Processed' && $orderList->num_rows >0){ echo $orderList->num_rows; }?></span> </div></a></li>
				   ...
				   <li><a title="" href="shops/<?php echo $selectSellershop_details[0]['seourl']; ?>/shop-orders?order=Delivered" class="" ><div class="name-inner"><?php echo "已送到";?> <span class="suborder"><?php if($_GET['order']=='Delivered' && $orderList->num_rows >0){ echo $orderList->num_rows; }?></span></div></a></li>
				   <li><a title="" href="shops/<?php echo $selectSellershop_details[0]['seourl']; ?>/shop-orders?order=Cancelled" class="" ><div class="name-inner"><?php echo "已取消";?> <span class="suborder"><?php if($_GET['order']=='Cancelled' && $orderList->num_rows >0){ echo $orderList->num_rows; }?></span></div></a></li>
