...
<section class="container">
  ...
  onblur="return check_shopname(this);"  onkeyup="return check_shopname(this);" style="width:425px; height:27px" />
					...
					<input type="text" class="checkout_txt" name="shop_location" id="shop_location" placeholder="<?php echo af_lg('lg_enter_location','Enter a location');?>" value="<?php  echo stripslashes($selectSeller_details[0]['shop_location']); ?>" style="width:425px; height:27px;" />
