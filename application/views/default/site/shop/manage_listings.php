                    ...
                    <?php $imgArr=explode(',',$shopDetail[$i]->image); ?>
                        <tr id="listing-<?php echo $shopDetail[$i]->id; ?>" class="row-1 odd">
                            ...
                            <td class="">
										...
										<a title="<?php echo shopsy_lg('lg_Edit_listing','Edit listing'); ?>" href="edit-product/<?php echo $shopDetail[$i]->seourl; ?>" style="margin-right: 15%;"><image src="images/site/edit_icon.png" /></a>
									   <a title="<?php echo shopsy_lg('lg_copy_listing','Copy listing'); ?>" href="copy-product/<?php echo $shopDetail[$i]->seourl; ?>"><image src="images/site/copy-icon.png" /></a>
										...
										<a class="<?php if($shopDetail[$i]->status != "Publish"){echo "not-active";} ?>" title="<?php echo shopsy_lg('lg_make_feature','Make it Feature'); ?>" href="site/cart/makeFeatrue/<?php echo $shopDetail[$i]->seourl; ?>" style="margin-right: 15%;"><image src="images/site/activity.png" /></a>
