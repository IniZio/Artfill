...
<section class="container">
 ...
 onblur="return check_shopname(this);"  onkeyup="return check_shopname(this);" style="width:425px; height:27px" />
            ...
            <div class="shop_member">
                <label class="label-text"><?php echo shopsy_lg('lg_current_bannerimage','Current Banner image');?></label>
    ...
    <div class="row">
      ...
      <div class="col-md-3" >
        ...
        <div class="docs-data" style="display:none;">
          ...
          <div class="input-group">
            <label class="input-group-addon" for="dataWidth"><?php echo shopsy_lg('lg_width','Width');?></label>
            <input class="form-control" id="dataWidth" name="width" type="text" placeholder="width">
            <span class="input-group-addon">px</span>
          </div>
          <div class="input-group">
            <label class="input-group-addon" for="dataHeight"><?php echo shopsy_lg('lg_height','Height');?></label>
        ...
        <div class="btn-group btn-group-crop" id="preview" style="display:none;">
          <button class="btn btn-primary" data-method="getCroppedCanvas" type="button">
            <span class="docs-tooltip" data-toggle="tooltip" title="$().cropper(&quot;getCroppedCanvas&quot;)">
             <?php echo shopsy_lg('lg_preview','preview');?>
            </span>
          </button>
        </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="getCroppedCanvasTitle"><?php echo shopsy_lg('lg_cropped','Cropped');?></h4>
              </div>
