     ...
     <div class="main"> 
	   <div class="feedback-container">
	      <ul class="nav nav-tabs" role="tablist">
	        ...
	        <li role="presentation" class="active"><a href="#seller" aria-controls="seller" role="tab" data-toggle="tab"><?php echo artfill_lg('lg_to_you','To You');?></a></li>
	        <li role="presentation"><a href="#buyer" aria-controls="buyer" role="tab" data-toggle="tab"><?php echo artfill_lg('lg_your_cases','Your Cases');?></a></li>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div id='cancel_order_popup' style='background:#fff;'>		
					...
					<h2 class="conversation_headline"><?php echo artfill_lg('lg_sry_cancelling_item','We are sorry to see that you have to Cancel this item. Tell us why and we will improve');?></h2>
...
<!-- 				<input class="conversation-subject" type="text" name="subject" placeholder="Subject" value="Re: Order #1439537778 on Aug 14,2015 ">  -->
					...
					<ul>
					<li><input type="radio" name="reason" value=""><?php echo artfill_lg('lg_products_reordered','Products reoredered');?></li>
					<li><input type="radio" name="reason" value=""><?php echo artfill_lg('lg_products_misplaced','Products misplaced');?></li>
					<li><input type="radio" name="reason" value=""><?php echo artfill_lg('lg_products_reorderdwithout','Products ordered without');?></li>
					<li><input type="radio" name="reason" value=""><?php echo artfill_lg('products_not_required','Products not required');?></li>
					</ul>
