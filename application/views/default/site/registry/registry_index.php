					...
					<div style="background:#EAF7FD;heigth:400px; margin:0px" class="sign_in_form">
						<div style="border:none; margin:0; padding:0" class="sign_in_form-inner">
							<div style="float:left; width:100%;" class="sign_head5">
								...
								<input type="text"  name="registryDate" id="registryDate" class="payment_txt required" placeholder="<?php echo artfill_lg('lg_select_date','Select the date');?>" value="" />	                 
						  ...
						  <div class="modal-footer footer_tab_footer">
								<div class="btn-group">
										 <input class="submit_btn" type="submit" value="<?php echo artfill_lg('lg_create_registry','Create Registry');?>" name="submitRegistry" />
