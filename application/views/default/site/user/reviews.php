...
<!-- feedback-container start -->
   <div class="feedback-container">
      ...
      <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation" class="active"><a href="#seller" aria-controls="seller" role="tab" data-toggle="tab"><?php echo artfill_lg('lg_order_fb','Order Feedbacks');?></a></li>
        <li role="presentation"><a href="#buyer" aria-controls="buyer" role="tab" data-toggle="tab"><?php echo artfill_lg('lg_purchase_fb','Purchase Feedbacks');?></a></li>
        
        <li role="presentation"><a href="#all-fbk" aria-controls="all-fbk" role="tab" data-toggle="tab"><?php echo artfill_lg('lg_all_fb','All Feedbacks');?></a></li>
      ...
      <div class="receive-fbk">
       ...
       <div class="period-choose hole_content">
        <label><?php echo artfill_lg('lg_period','Period:');?> </label>
        <select id="stats">
            <option value="site/product/reviews" ><?php echo artfill_lg('lg_all','All');?></option>
            <option <?php if(isset($_GET['month']) && $_GET['month'] == '12' ){ echo "selected"; }?> value="site/product/reviews?month=12" ><?php echo artfill_lg('lg_12_months','12 Months');?></option>
            <option <?php if(isset($_GET['month']) && $_GET['month'] == '6' ){ echo "selected"; }?> value="site/product/reviews?month=6"><?php echo artfill_lg('lg_6_months','6 Months');?></option>
            <option <?php if(isset($_GET['month']) && $_GET['month'] == '3' ){ echo "selected"; }?> value="site/product/reviews?month=3"><?php echo artfill_lg('lg_3_months','3 Months');?></option>
        </select>
      </div>
      <!-- Tab panes -->
      <div class="tab-content fbk-tbl hole_content">
        ...
        <div role="tabpanel" class="tab-pane active" id="seller">
			<span class="recv-fbk"><strong><?php echo $user_review->num_rows();?></strong> <?php echo artfill_lg('lg_fb_received','Feedback(s)  Received');?></span>
			<?php if($user_review->num_rows() != 0){?>
		   <table class="table" id="property_table">
                <thead class="fbk-thead">
                  <tr>
					<th><?php echo artfill_lg('lg_title','Title');?></th>
                    <th><?php echo artfill_lg('lg_feedback','Feedback');?></th>
					<th><?php echo artfill_lg('lg_from_user','From User');?></th>
                    <th><?php echo artfill_lg('lg_rating','Rating');?></th>
                    <th><?php echo artfill_lg('lg_when','When');?></th>
                  </tr>
                </thead>
                <tbody>
				<?php
        ...
        <div role="tabpanel" class="tab-pane" id="buyer">
			<span class="recv-fbk"><strong><?php echo $my_review->num_rows();?></strong><?php echo artfill_lg('lg_fb_sent','Feedback(s) Sent');?></span>
		   ...
		   <table class="table" id="property_table">
                <thead class="fbk-thead">
                  <tr>
                    ...
                    <th><?php echo artfill_lg('lg_feedback','Feedback');?></th>
				    <th><?php echo artfill_lg('lg_rating','Rating');?></th>
                    <th><?php echo artfill_lg('lg_product','Product');?></th>
                    <th><?php echo artfill_lg('lg_when','When');?></t
                  </tr>
                </thead>
                <tbody>
				<?php					
        ...
        <div role="tabpanel" class="tab-pane" id="all-fbk">
           <span class="recv-fbk"><strong><?php echo $all_feedback->num_rows();?></strong> <?php echo artfill_lg('lg_fb','Feedback(s)');?></span>
		   ...
		   <table class="table" id="property_table">
                <thead class="fbk-thead">
                  <tr>
                    ...
                    <th><?php echo artfill_lg('lg_feedback','Feedback');?></th>
				    <th><?php echo artfill_lg('lg_rating','Rating');?></th>
                    <th><?php echo artfill_lg('lg_name','Name');?></th>
                    <th><?php echo artfill_lg('lg_when','When');?></th>
                  </tr>
                </thead>
                <tbody>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div id='cancel_order_popup' style='background:#fff;'>		
					...
					<h2 class="conversation_headline"><?php echo artfill_lg('lg_sry_msg','We are sorry to see that you have to Cancel this item. Tell us why and we will improve');?></h2>
...
<!-- 				<input class="conversation-subject" type="text" name="subject" placeholder="Subject" value="Re: Order #1439537778 on Aug 14,2015 ">  -->
					...
					<ul>
					<li><input type="radio" name="reason" value=""><?php echo artfill_lg('lg_products_reordere','Products reoredered');?></li>
					<li><input type="radio" name="reason" value=""><?php echo artfill_lg('lg_products_misplaced','Products misplaced');?></li>
					<li><input type="radio" name="reason" value=""><?php echo artfill_lg('lg_pro_order_without','Products ordered without');?></li>
					<li><input type="radio" name="reason" value=""><?php echo artfill_lg('lg_pro_not_req','Products not required');?></li>
					</ul>
