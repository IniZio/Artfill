    ...
    <div class="favorite favorite_box">
        ...
        <div class="main">    
            ...
            <div id="activities">
				...
				$userProfileDetails= $this->user_model->get_all_details(USERS,array('id'=>$actBuyPick['seller_id']))->result_array();
            ...
            <div id="activities">
                <?php if(!empty($isSellerPickupActivities)){ ?>

                <ul class="activity-list" id="activity-list activity-list-1">

                <?php $hover=0; $s=0;$l=1; foreach($isSellerPickupActivities as $actSellerPick){ ?>

                <?php if($s<3 && $l<4){ $cls="small"; $s++; } else if($s>2 && $l<4){ $cls="large"; $l++;} else {$s=0;$l=1;}?>

                <?php 

                $userProfileDetails= $this->user_model->get_all_details(USERS,array('id'=>$actSellerPick['user_id']))->result_array();

                if($actSellerPick['activity_name']=='pickup item') { 

                $hover++;

                    $productDetail = $this->user_model->get_all_details(PRODUCT,array('id'=>$actSellerPick['activity_id']))->row();
                    ...
                    <li class="activity small-wid <?php echo $cls; ?>">
                        ...
                        <div class="activity-desc">
                            ...
                            <p class="activity-name">
                               ...
                               <a class="member-name" href="products/<?php echo $productDetail->seourl; ?>"> <?php if($this->lang->line('user_thisitem') != '') { echo stripslashes($this->lang->line('user_thisitem')); } else echo "this item"; ?>.<?php #echo str_replace("item","this item",$actSellerPick['activity_name']); ?>.</a>
