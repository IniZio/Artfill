...
<section class="container"> 
        ...
        <div class="heading" style="font-size:16px;"><?php if($this->lang->line('shop_feedback') != '') { echo stripslashes($this->lang->line('shop_feedback')); } else echo 'Shop Feedback'; ?></div>
...
<p class="feed-cnt1"><?php echo stripslashes($details['description']);?></p>       
          ...
          <div> <?php echo $paginationLink; ?> </div>
