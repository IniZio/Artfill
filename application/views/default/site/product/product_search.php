                      ...
                      <?php 
                      	//}
                                	...
                                	<ul class="price-input">
                                    	<li class="changeable selected"><?php echo artfill_lg('lg_price','Price');?></li>
...
<!--------- Color Filter with Slider starts --->                                
                                 <ul id="facet-price" class="filter first">
                                	<ul class="price-input">
                                    	<li class="changeable selected"><?php echo artfill_lg('lg_color','Color') ?></li>
                                    </ul>
                                </ul>
...
<!--------- Color Filter with Slider ends--->   
                               ...
                               <?php if($this->config->item('deal_of_day') == 'Yes'){ ?>
                                <ul class="filter shop-in">
                                    <li class="input-group selected" id="shiptobox"><?php //echo artfill_lg('lg_product_type','Product Type') 
												echo artfill_lg('lg_deal_of_the_day','Deal Of The Day');
												?></li>
                                    
                                  
                                    
                                    <?php i?><a href="<?php  echo $c_url.'?'.$s_key.$s_gift.$min_price.$max_price.$location.$shipto.$order.$colorVal.'&dealday=today';?>"><p style="margin: 5px 5px 5px 15px;"> <?php echo artfill_lg('lg_todays_deal','Todays Deals');?> </p></a><?php  ?>
                                    <?php  ?><a href="<?php  echo $c_url.'?'.$s_key.$s_gift.$min_price.$max_price.$location.$shipto.$order.$colorVal.'&dealday=upcoming';?>"><p style="margin: 5px 5px 5px 15px;"><?php echo artfill_lg('lg_upcoming_deals','Upcoming Deals');?> </p></a><?php  ?>
                                </ul>
                                <?php } ?>
                            </div>
                        </div>
                         ...
                         <div class="sort-options no-views btn-secondary">
                            ...
                            <ul id="menu">
								...
								if($this->input->get('order') == 'date_desc'){
								     echo artfill_lg('shopsec_recent','Most Recent'); $recentAct='active';
								}  else if($this->input->get('order') == 'most_relevant') { 
									 echo artfill_lg('seller_relevancy','Relevancy'); $relevanttAct='active';
								} else if($this->input->get('order') == 'price_desc'){
								     echo artfill_lg('lg_highest price','Highest Price'); $priceHigh='active';
								} else if($this->input->get('order') == 'price_asc'){
									 echo artfill_lg('lg_lowest price','Lowest Price'); $priceLow='active';
								}
                                ...
                                <img src="images/down_arrow.png"></a>
                                    ...
                                    <li><a href="<?php  echo $c_url.'?'.$s_key.$s_gift.$min_price.$max_price.$location.$shipto.'&order=most_relevant';?>" id="Alphabetical" class="<?php echo $relevanttAct;?>"><?php if($this->lang->line('seller_relevancy') != '') { echo stripslashes($this->lang->line('seller_relevancy')); } else echo "Relevancy"; ?></a></li>
                                     <li><a href="<?php  echo $c_url.'?'.$s_key.$s_gift.$min_price.$max_price.$location.$shipto.'&order=price_desc';?>" id="Highest" class="<?php echo $priceHigh;?>"><?php echo artfill_lg('lg_highest price','Highest Price');?></a></li>
                                    <li><a href="<?php  echo $c_url.'?'.$s_key.$s_gift.$min_price.$max_price.$location.$shipto.'&order=price_asc';?>" id="Lowest" class="<?php echo $priceLow;?>"><?php echo artfill_lg('lg_lowest price','Lowest Price');?></a></li>
                                </li>
                             </ul>
