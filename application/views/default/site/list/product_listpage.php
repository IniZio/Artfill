      ...
      <!--<div class="col-md-9 pull-right filter-button-right col-xs-12 ">
        <div class="filter-button-inside"> 
		 ...
		 <?php if($this->input->get('color') != '') {?>
					...
					<div class="filter-input facet">
					  <label>Color 
						  <select class="filtering-input" name="filterByColor" id="filterByColor">
								<option value=""><?php echo artfill_lg('lg_choose color','choose color..');?></option>
			...
			<a href="javascript:void(0);"><?php echo artfill_lg('lg_color','color');?></a></div>	
			<?php } else {?>	
		   <div  id="filter_byColor" class="filter-button"><a href="javascript:void(0);"><?php echo artfill_lg('lg_color','color');?></a></div>
        <?php }?>
