		...
		<div class="container">
			...
			<div class="right_side width-full">
				<div class="add_listimg shop-detail shopview_info">
					...
					<ul class="reviews-bg">
						<li>
							<span><?php echo artfill_lg('lg_reviews','Reviews');?></span>
							<span class="reviews">
				...
				<div id="shop-detail-info" class="shopview_info">
					<ul>
						...
						<?php
							...
							if($loginCheck!=''){
						?>
							<li><a href="javascript:void(0);" onclick="add_delete_follow(<?php if(!(in_array($seller_shoper_id,$following_user_list))) echo "'add_follow' , '".$seller_shoper_id."'"; else echo "'delete_follow' , '".$seller_shoper_id."'"; ?>)"><?php if(!(in_array($seller_shoper_id,$following_user_list))) echo artfill_lg('lg_follow', 'Follow'); else echo artfill_lg('lg_following','Following'); ?></a>
						<?php
							}
						?>
...
<?php /*?>						<li>
						...
						<ul>
							<li>
								<a <?php if($this->uri->segment(3)=='sales'){?>class="art-active"<?php } ?> href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/sales'; ?>">
									...
									<span><span><?php echo count($get_seller_sales_qry); ?></span> <?php echo artfill_lg('lg_sales','Sales');?></span>
								</a>						
							</li>
							<li>
								<a <?php if($this->uri->segment(3)=='favorites'){?>class="art-active"<?php } ?> href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/favorites'; ?>">
									<span class="shop-icon icon-37"></span>
									<span><span><?php echo $Shopadmirers; ?></span> <?php echo artfill_lg('lg_favorites','Favorites');?>
									</span></span>
								</a>
							</li>
							<li>
								<a <?php if($this->uri->segment(3)==''){?>class="art-active"<?php } ?> href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2); ?>">
									<span class="shop-icon icon-37"></span>
									<span><?php echo count($get_shop_selection_products)."   "; ?><?php echo artfill_lg('lg_products','Products');?></span>
								</a>
							</li>
							<!--<li>
								<a href="">
							...
							<li style="float:right">
								<a <?php if($this->uri->segment(3)=='followings'){?>class="art-active"<?php } ?> href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/followings'; ?>">
									...
									<span><span><?php echo count($followingUserDetails);?></span>  <?php echo artfill_lg('lg_follow','Follow');?></span>
								</a>
							</li>
							<li style="float:right">
								<a <?php if($this->uri->segment(3)=='followers'){?>class="art-active"<?php } ?> href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/followers'; ?>">
									...
									<span><span><?php echo count($followerUserDetails);?></span> <?php echo artfill_lg('lg_followers','Followers');?></span>
								</a>							
							</li>
						</ul>
					</div>
			   ...
			   <div style=" margin-top: 10px;padding-left: 55px;float: left;">
					...
					?>
							<b><?php echo artfill_lg('lg_shop_accpts_giftcards','This Shop Accepts Shopsy Gift Cards.');?><b>
					<?php	}
					?>
							...
							<div class="conversation_container">
								...
								<div class="conversation_right">
									...
									<input type="hidden" name="productseourl" id="productseourl" value="<?php echo $added_item_details[0]['seourl']; ?>" >
										<input class="conversation-subject" type="text" name="subject" id="subject" placeholder=<?php echo artfill_lg('lg_subject','Subject');?> />
