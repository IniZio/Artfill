...
speedTest.showMarkers = function(){
  ...
  if(speedTest.data.length > 0){
	 jQuery.each(speedTest.data, function(i, item){
		...
		title.className = 'title';
		title.innerHTML = '<span><?php echo af_lg('lg_noshop found','No Shop are found.....');?></span>';
		items.appendChild(title);
		panel.appendChild(items);
	}
...
<div class="col-lg-12 search-location">
	<div class="col-lg-3 search-location-left">
		<div class="col-lg-12">
			<input type="text" class="form-control " placeholder="<?php echo af_lg('lg_enter your addr','Enter your address');?>" id="autocomplete" id="autocomplete" name="task_location">
			<input style="display:none;" type="checkbox" checked="checked" id="usegmm"/>
		</div>
		<div class="col-lg-12 margin-top-15" style="padding: 3px;">
			<div class="col-lg-5" style="margin-top: 5px;"><p><?php echo af_lg('lg_showshops','Show shops');?></p></div>
			<div class="col-lg-7">
		...
		<div class="col-lg-12 margin-top-15"><p><?php echo af_lg('lg_shoplist','shop list');?></p></div>
