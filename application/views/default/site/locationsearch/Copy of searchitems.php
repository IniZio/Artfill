	...
	<div class="col-lg-3 search-location-left">
		...
		<div class="col-lg-12 margin-top-15">
			<select id="main-subCat" onchange="changeFilter(this);" style="height:30px;">
				<option value=""><?php echo shopsy_lg('lg_filter_by_categ','Filter by Category');?></option>
		...
		<div class="col-lg-12 margin-top-15" style="padding: 3px;">
			<div class="col-lg-5" style="margin-top: 5px;"><p><?php echo shopsy_lg('lg_show items','Show Items');?></p></div>
			<div class="col-lg-7">
		...
		<div class="col-lg-12 margin-top-15"><p><?php echo shopsy_lg('lg_itemlist','Item List');?></p></div>
