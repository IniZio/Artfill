		...
		<ul>
			<li>
				<a href="view-local-events">
					...
					<?php echo artfill_lg('lg_view_localevents','View Local Events');?>
				</a>
			</li>
			<li>
				<a href="shop-by-location">
					<!--<img src="images/5.png" class="img-responsive">-->
				<?php echo artfill_lg('lg_shop_by_location','Shop by location');?>
				</a>
			</li>
			<li>
				<a href="shop-by-items">
					<!--<img src="images/4.png" class="img-responsive">-->
				<?php echo artfill_lg('lg_shop_by_items','Shop by items');?>
				</a>
			</li>
		</ul>
...
<div class="col-lg-12 margin-top-15">
	<div class="col-lg-3">
		...
		<div class="col-lg-12 margin-top-15">
			...
			<option value=""  style="padding:7px;"><?php echo artfill_lg('lg_filter by date','Filter by Date');?></option>
			<option value="today"><?php echo artfill_lg('lg_today','Today');?></option>
			<option value="week"><?php echo artfill_lg('lg_this week','This Week');?></option>
			<option value="cmonth"><?php echo artfill_lg('lg_this month','This Month');?></option>
			<option value="nmonth"><?php echo artfill_lg('lg_next month','Next Month');?></option>
			<option value="year"><?php echo artfill_lg('lg_this year','This Year');?></option>
			</select>
		</div>
		<div class="col-lg-12 margin-top-15" style="padding: 3px;">
			<div class="col-lg-5" style="margin-top: 5px;"><p><?php echo artfill_lg('lg_show events','Show Events');?></p></div>
			<div class="col-lg-7">
		...
		<div class="col-lg-12 margin-top-15"><p><?php echo artfill_lg('lg_events list','Events List');?></p></div>
