		...
		<div class="modal-content" style="float:left;">
			...
			<div style="margin:5px;border: 2px dashed #8adbd4; border-radius:5px;float:left;">
				...
				<form method="post" action="" class="frm clearfix" onSubmit="return loginVal(this);">
					...
					<a data-toggle="modal" href="#signup" style="font-size: 12px; width:100%;" onclick="$('signin').attr('aria-hidden','true');return false;"><?php echo af_lg('user_register',"新會員註冊"); ?></a>					
					</div>
				</form>
				<hr/>
				...
				<div style="clear:both;"></div>
									...
									<form  method="post" action="" class="frm clearfix" onSubmit="return register_user(this);">
										...
										<div class="popup_login" style="margin-bottom:15px">
											...
											<button id="register1" type="submit" class="btn btn-primary submit-btn ladda-button" data-style="expand-right" data-size="s"><span class="ladda-label"><?php echo af_lg('user_register', "Register"); ?></span></button>
