...
<!-- header_start -->
 ...
 <div class="header_top animated bounceInDown hidden-xs" style="position:relative;">
    ...
    ?>
					...
					<!--new elements-->
					<div class="hidden-xs">
						<a href="<?php echo base_url(); ?>" title="<?php echo artfill_lg('lg_home', 'Home'); ?>"><span style="color:white;">首頁</span></a>
    ...
    ?>" value="<?php if ($this->input->get('item') != '') {echo htmlspecialchars($this->input->get('item'));}?>" id="search_items" autocomplete="off" >
							...
							<input type="submit" value="<?php echo artfill_lg('heading_search', 'Search'); ?>" class="search-bt">
						</form>
						<div id="sugglist"></div>
					</div>
...
break;}
    ...
    ?>
					...
					<div class="col-md-5 col-xs-5 top-login">
						<ul class="header_menu">
							<li>
								<a href="<?php echo base_url(); ?>" id="home" title="<?php echo artfill_lg('lg_home', 'Home'); ?>">
    ...
    ?></span>
							...
							<li>
								<a href="shop/sell" id="shop" title="<?php echo artfill_lg('lg_you_shop', 'You Shop'); ?>">
...
break;}
				  ...
				  <!--
				    <div class="col-md-5 col-xs-5 top-login">
						...
						<ul class="header_menu">
							...
							<li>
								<a href="<?php echo base_url(); ?>home" id="home" title="<?php echo artfill_lg('lg_home', 'Home'); ?>">
									<span class="icon-text"><?php if ($this->lang->line('landing_home') != '') {echo stripslashes($this->lang->line('landing_home'));} else {
        echo 'Home';
    }
    ?></span>
							...
							<li>
								<a id="favorites" href="people/<?php echo $this->session->userdata['shopsy_session_user_name']; ?>/favorites" title="<?php echo artfill_lg('lg_favorites', 'Favorites'); ?>">
    ...
    ?></span>
							...
							<li>-->
									...
									<!--
								<a class="dropdown-toggle browse "  data-toggle="dropdown" id="you1" title="<?php echo artfill_lg('lg_you', 'You'); ?>">
									<span class="icon-text">
									<?php echo artfill_lg('lg_you', 'You'); ?>
						...
						<div class="item <?php if ($i == 0) {echo 'active';}?>">
									...
									<div class=" container hero-in hero-in-1">
									  ...
									  <?php if ($sliders->title != '') {?>
										...
										<a class="banner-bt" href="<?php echo trim(prep_url($sliders->link)); ?>" target="_blank" /><?php echo artfill_lg('lg_readmore', 'Read More'); ?></a> <?php }?>
