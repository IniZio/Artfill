 ...
 <div class="header_top" style="position:relative;">
		...
		<?php if($this->session->userdata['shopsy_session_user_name'] == '' || true){?>
			<div class="container top">
				<div class="row" style="padding-bottom:30px;magrin-bottom:30px;margin-top:40px;">
					...
					<div>
						...
						<img src="./images/eng.png" style="width:30px;" />
						</a>
					</div>
		...
		<div class="header_top header_fixed_menu" style="background-image:none;position:relative;">
				...
				<style>
					...
					<div class="col-md-2 col-xs-12 top-login"> 				
						<ul class="header_menu">
						<!--
							<li>
								<a href="<?php echo base_url();?>" id="home" title="<?php echo shopsy_lg('lg_home','Home'); ?>">
						...
						-->
							...
							<li>
								<a class="dropdown-toggle browse" data-toggle="dropdown"><img src="./images/user-silhouette.png" style="width:20px;" /><span style=" font-weight: bold;font-size:120%;margin-left:5px;">你好，<?php echo $this->session->userdata['shopsy_session_user_name'];?></span></a>	
