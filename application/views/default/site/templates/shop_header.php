...
<div class="add_shop">
  <div class="main" style="width:100%;">
    ...
    <ul id="panel" class="add_steps" style="background:none; box-shadow:none;">
      ...
      <a title="<?php echo shopsy_lg('lg_Choose_Your_Shop_Name','Choose Your Shop Name');?>" 
      ...
      <li <?php if ($this->uri->segment(2) == 'listitem' && $this->uri->segment(1) == 'shop'){ ?> class="side_active" <?php } ?>>
        <?php if($selectSellershop_details[0]['seller_businessname'] != '') { ?>
        	<a title="<?php echo shopsy_lg('lg_What_going_to_sell_Add_edit_listings','What are you going to sell? Add and edit listings here.');?>" href="shop/listitem" class="<?php if($this->uri->segment(2)=='listitem'){ echo 'shop_active_tab';} ?> "> 
        ...
        <?php } else { ?>
		 ...
		 <li <?php if ($this->uri->segment(2) == 'managelistings' && $this->uri->segment(1) == 'shop'){ ?> class="side_active" <?php } ?> >
          <?php if(count($shopProduc)!= 0) { ?>
        	<a title="<?php echo shopsy_lg('lg_Manage_listings','Manage your listings here.');?>" href="shop/managelistings" class="<?php if($this->uri->segment(2)=='managelistings' || $this->uri->segment(1)=='edit-product'){ echo 'shop_active_tab';} ?>"> 
      ...
      <li <?php if ($this->uri->segment(1) == 'shop' && ($this->uri->segment(2) == 'payment' || $this->uri->segment(2) == 'billing')){ ?> class="side_active" <?php } ?> ><a style="padding:0px !important;" href="javascript:void(0)"><div class="name-inner"><?php if($this->lang->line('payment_settings') != '') { echo stripslashes($this->lang->line('payment_settings')); } else echo 'Payment Settings'; ?><b class="caret" style="position: static;"></b></div></a>
		...
		<ul class="add_shop_drop_down">
			...
			<?php $processedorder = $this->order_model->view_shop_order_details('Paid',$shop_id,'Processed'); ?>
			   <li><a title="" href="shops/<?php echo $selectSellershop_details[0]['seourl']; ?>/shop-orders?order=Processed" class="" ><div class="name-inner"><?php echo shopsy_lg('lg_processed','Processed');?> (<?php echo $processedorder->num_rows();?>)</div></a></li>
			<?php $shippedorder = $this->order_model->view_shop_order_details('Paid',$shop_id,'Shipped'); ?>   
            <li><a title="" href="shops/<?php echo $selectSellershop_details[0]['seourl']; ?>/shop-orders?order=Shipped" class="" ><div class="name-inner"><?php echo shopsy_lg('lg_shipped','Shipped');?>(<?php echo $shippedorder->num_rows();?>)</div></a></li>
			<?php $deliveredorder = $this->order_model->view_shop_order_details('Paid',$shop_id,'Delivered'); ?>
			   <li><a title="" href="shops/<?php echo $selectSellershop_details[0]['seourl']; ?>/shop-orders?order=Delivered" class="" ><div class="name-inner"><?php echo shopsy_lg('lg_delivered','Delivered');?> (<?php echo $deliveredorder->num_rows();?>)</div></a></li>
			<?php $cancelledorder = $this->order_model->view_shop_order_details('Paid',$shop_id,'Cancelled'); ?>
			   <li><a title="" href="shops/<?php echo $selectSellershop_details[0]['seourl']; ?>/shop-orders?order=Cancelled" class="" ><div class="name-inner"><?php echo shopsy_lg('lg_cancelled','Cancelled');?> (<?php echo $cancelledorder->num_rows();?>)</div></a></li>
			<?php $returnorder = $this->order_model->view_shop_order_details('Paid',$shop_id,'dispute'); ?>  
			   <li><a title="" href="shops/<?php echo $selectSellershop_details[0]['seourl']; ?>/shop-orders?order=dispute" class="" ><div class="name-inner"><?php echo shopsy_lg('lg_returnreplace','Return / Replace');?> (<?php echo $returnorder->num_rows();?>)</div></a></li>
			<?php $codorder = $this->order_model->view_shop_cod_details('COD',$shop_id); ?>   
			   <li><a title="" href="shops/<?php echo $selectSellershop_details[0]['seourl']; ?>/shop-orders?order=cod" class="" ><div class="name-inner"><?php echo shopsy_lg('lg_cod','Cash on Delivery');?> (<?php echo $codorder->num_rows();?>)</div></a></li>
			   <?php $wiretransferorder = $this->order_model->view_shop_cod_details('wire_transfer',$shop_id); ?>   
			   <li><a title="" href="shops/<?php echo $selectSellershop_details[0]['seourl']; ?>/shop-orders?order=wiretransfer" class="" ><div class="name-inner"><?php echo shopsy_lg('lg_wiretransfer','Wire Transfer');?>(<?php echo $wiretransferorder->num_rows();?>)</div></a></li>
			    <?php $westernunionorder = $this->order_model->view_shop_cod_details('western_union',$shop_id); ?>   
			   <li><a title="" href="shops/<?php echo $selectSellershop_details[0]['seourl']; ?>/shop-orders?order=westernunion" class="" ><div class="name-inner"><?php echo shopsy_lg('lg_westernunion','Western Union');?>(<?php echo $westernunionorder->num_rows();?>)</div></a></li>
		</ul>
