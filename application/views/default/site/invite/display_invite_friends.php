    ...
    <div class="main">
        <div class="container">
            <ul class="breadcrumb_top">
                ...
                <li>></li>
                <li><?php echo artfill_lg('lg_invite_friends','Invite friends');?></li>
            </ul>
            <div class="left_side">   
                <?php //$this->load->view('site/user/sidebar'); ?>
            </div>
            <div class="right_side" >
				<div class="split_prefile">
                        <h2><?php echo artfill_lg('lg_invite your friends','Invite Your Friends');?></h2>
                        <div class="clear"></div>
