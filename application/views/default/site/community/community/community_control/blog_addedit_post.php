...
<section class="container">	
     ...
     <div class="hole_content">
      <div class="heading"> <?php if($this->lang->line('com_news') != '') { echo stripslashes($this->lang->line('com_news')); } else echo "News"; ?></div>
            ...
            <div> 
             <span class="store_heading" style="width: 714px;" ><?php if($this->lang->line('user_image') != '') { echo stripslashes($this->lang->line('user_image')); } else echo af_lg('lg_image','Image');?> <span style="color:#F00;">*</span>
