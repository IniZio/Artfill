	...
	<section class="container">
    	<div class="main">
        	<ul class="bread_crumbs">
                ...
                <span>›</span>
                <li><a href="shop/sell"><?php echo artfill_lg('lg_ur_shop','Your Shop');?></a></li>
                <span>›</span>
                <li><?php echo artfill_lg('lg_display_zendesk_ticket','Display Zendesk Tickets');?></li>
            </ul>
                ...
                <div class="conversation_container" style="margin-bottom: 12px;">
				   <div class="conversation_container_right" style="width:100%;">     
                        ...
                        <div class="ticket_header">
							<span><h3><?php echo artfill_lg('lg_display_zendesk_ticket','Display Zendesk Tickets');?>
								<a href="#create_ticket_popup" data-toggle="modal">
									<label class="addticket"> <h5><i class="fa fa-plus"></i><?php echo artfill_lg('lg_add_ticket','Add Ticket');?></h5></label> </h3> 
								</a>
							</span>
						</div>
                       ...
                       <?php  for($i=0; $i < count($tickets); $i++){  ?>
						 <a href="view-zendesk-tickets/<?php echo $tickets[$i]->id;?>">
							<ul  class="message-box" id="Msg_<?php echo $tickets[$i]->id;?>">
								...
								<li  class="statusLi">
								   ...
								   <span class="ticket_status"><?echo artfill_lg('lg_open','Open');?></span>
								   <?php } else { ?>
                        ...
                        <?php 
							...
							?>
                         <span style="text-align:center;"><h3 style="margin:5%; text-align:center; "><?php echo artfill_lg('lg_no_ticket_found','No Tickets Found');?></h3></span>
                        <?php } else { ?>
						<form action="site/zendesk/create_zendesk_user" method="post" id="zendesk_form">
							<a href="javascript:void(0);" onclick="javascript: $('#zendesk_form').submit();">
								<span style="text-align:center;"><h3 CLASS="createZenAccount"><?php echo artfill_lg('clk_here','Click Here To Create Account With Zendesk');?></h3></span>
							</a>
					...
					<div class="conversation_container">				
						<div class="conversation_right">
							<form name="contactpeople" id="create_zendesk_ticket_form" method="post" action="site/zendesk/create_vendor_zendesk_ticket" onsubmit="return zenCheck();">
								<input class="conversation-subject" type="text" name="subject" id="subject" placeholder="<?php echo artfill_lg('lg_subject_conv','Subject of the Conversation');?>" style="width:610px;" value="" >
								...
								<span style="float:right; margin-bottom: 2%; margin-right: 7%;">
									<?php echo artfill_lg('lg_priority','Priority : ');?>
									<select name="priority" id="priority">
										<option selected="selected" value="low"><?php echo artfill_lg('lg_low','Low');?></option>
										<option value="normal"><?php echo artfill_lg('lg_home','Normal');?></option>
										<option value="high"><?php echo artfill_lg('lg_high','High');?></option>
										<option value="urgent"><?php echo artfill_lg('lg_urgent','Urgent');?></option>
									</select>
								</span>
								...
								<div class="modal-footer footer_tab_footer">
								 <span style="float:left;" id="ErrPUP" class="error"></span>
									<div class="btn-group">
											...
											<a class="btn btn-default submit_btn" data-dismiss="modal" id="contact_reg"><?php echo artfill_lg('lg_cancel','Cancel');?></a>
									</div>
								</div>
