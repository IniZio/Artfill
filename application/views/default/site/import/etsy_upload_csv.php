...
<section class="container">
	<div class="main">
		<div class="shop_details">   
			<span class="shop_title"><?php echo artfill_lg('lg_pls_choose_your_csv_file','Please choose your CSV file');?></span>
						...
						<div class="import-list">
							<form name="csvdata" method="post" action="site/product_import/import_from_etsy" id="csvdata" enctype="multipart/form-data">
								...
								<div>
									...
									<input type="submit" id="btn-etsy" value="<?php echo artfill_lg('lg_upload','Upload');?>" class="btn btn-primary">
								</div>
		...
		<div class="modal-content">
			<div class="modal-wrapper" id="popWrapper">
				<div class="text-center" id="popUpLoad">
					...
					<h4><?php echo artfill_lg('lg_import_product_pls_wait','Importing Product, Please Wait...');?></h4>
				</div>
			</div>
		</div>
	</div>
