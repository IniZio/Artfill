...
<section class="second-bl" style="display:none;">
	<div class="container">
		<h1 class="today-deal"><!--<a href="<?php echo base_url(); ?>search/all?&dealday=today"><?php echo artfill_lg('lg_Today_Deal', 'Today\'s Deal'); ?><i class="fa fa-caret-right deal-arrow"></i></a>-->今日優惠</h1>
