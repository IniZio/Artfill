...
<script type="text/javascript" src="js/site/overlay.js"></script>
							...
							<section class="second-bl">
								  <div class="container">
									<h1 class="today-deal">熱門商品</h1>
												...
												<div class=" rf-bl hoverrf-bl">
														...
														<div class="carousel slide" data-ride="carousel" id="<?php echo 'productCarousel' . $i; ?>">
															...
															<div class="carousel-inner" role="listbox" style="max-width: 205px !important; max-height: 203px !important;">
																<div class="item active">
																	<a href="#product/<?php echo $recent_product_details->row($i)->product_seourl; ?>"><img src="images/product/cropmed/<?php echo $img[0]; ?>" alt="recent" style="max"> </a>
																</div>
																<?php foreach (array_slice($img, 1) as $element) {?>
																<div class="item">
																	<a href="#product/<?php echo $recent_product_details->row($i)->product_seourl; ?>"><img src="images/product/cropmed/<?php echo $element; ?>" alt="recent" style="max"> </a>
																</div>
																<?php }?>
															</div>
													...
													<!-- owner avatar -->
														...
														<!-- product name -->
															...
															<a href="#product/<?php echo $recent_product_details->row($i)->product_seourl; ?>" alt="<?php echo character_limiter($recent_product_details->row($i)->product_name, 25); ?>"><?php echo character_limiter($recent_product_details->row($i)->product_name, 25); ?></a>
														    </div>
										...
										<div class="single-product page" style="display: block;">
											<div class="overlay" style="background-color: rgba(60,60,60,0.5);"></div>
