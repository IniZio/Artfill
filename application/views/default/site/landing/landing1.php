...
<section class="second-bl">
	<div class="container">
		<h1 class="today-deal"><a href="<?php echo base_url();?>search/all?&dealday=today"><?php echo shopsy_lg('lg_Today_Deal','Today\'s Deal');?><i class="fa fa-caret-right deal-arrow"></i></a></h1>
				...
				<div class="recent-fav">
					...
					<div class="col-md-4 rf-bl">
						...
						if($deal_of_day[$i]->price!= 0.00){
											$price=$deal_of_day[$i]->price; $pls='';
						$offer=($deal_of_day[$i]->discount/100)*$price;
										} else{
											$price=$deal_of_day[$i]->pricing; $pls='+';
						$offer=($deal_of_day[$i]->discount/100)*$price;
										}
						...
						<div class="recent-review" style="margin-top: -26px;"  >
							...
							<div class="recent-right">
								<p ><?php if($this->lang->line('user_from') != '') { echo stripslashes($this->lang->line('user_from')); } else echo 'From'; ?> -  <a href="shop-section/<?php echo $deal_of_day[$i]->shop_seourls?>"> <?php echo $deal_of_day[$i]->full_name; ?></a>
							</p>
							<div   class="rating-input rating readonly-rating" data-score="<?php echo number_format($deal_of_day[$i]->shop_ratting,2); ?>" ></div>
							<span class="review-txt"> <?php echo $deal_of_day[$i]->review_count; ?> <?php if($this->lang->line('shopsec_reviews') != '') { echo stripslashes($this->lang->line('shopsec_reviews')); } else echo "Reviews"; ?></span>
						</div>
					</div>
				...
				<h5><?php /* if($this->lang->line('landing_text') != '') { echo stripslashes($this->lang->line('landing_text')); } else echo 'Discover finds from around the marketplace'; */?> </h5>
				    <div class="">
						...
						<div class="col-md-4 rf-bl">
							...
							$price=$featured_product_details->row($i)->price; $pls=''; 
							        $offer=($featured_product_details->row($i)->discount/100)*$price;
							} else{ 
							$price=$featured_product_details->row($i)->base_price; $pls='+'; 
							        $offer=($featured_product_details->row($i)->discount/100)*$price;
							} 
							      $dealprice=$price-$offer;
							...
							?>
							  ...
							  <div class="recent-bl">
								...
								<img src="images/<?php echo $profile_pic?>" alt="<?php echo $featured_product_details->row($i)->full_name; ?>" width="55px" class="img-circle" >
								            <div class="recent-right">
									<p ><?php if($this->lang->line('user_from') != '') { echo stripslashes($this->lang->line('user_from')); } else echo 'From'; ?> -  <a href="shop-section/<?php echo $featured_product_details->row($i)->shop_seourls?>"> <?php echo $featured_product_details->row($i)->full_name; ?></a>
								                </p>
								...
								<span class="review-txt"> <?php echo $featured_product_details->row($i)->review_count; ?> <?php if($this->lang->line('shopsec_reviews') != '') { echo stripslashes($this->lang->line('shopsec_reviews')); } else echo "Reviews"; ?></span>
							              </div>
						          </div>
		...
		<section class="third-bl">
			...
			<section class="second-bl third-bl">
				  <div class="container">
					...
					<?php */}?>
					<?php  //echo("<pre>");print_r($recent_product_details->result());die;
						...
						<section class="second-bl" style="border-top:thick solid #66f4cf;">
							  <div class="container">
								<h1><?php //echo shopsy_lg('lg_recent_product','Recent Products');?>熱門商品</h1>
								<h5><?php /*if($this->lang->line('landing_text') != '') { echo stripslashes($this->lang->line('landing_text')); } else echo 'Discover finds from around the marketplace';*/ ?> </h5>
								    <div class="">
									      <div class="recent-fav">
										        
										<?php
										  #print_r($recent_product_details->result());
										...
										<div class="row" style="margin:10px;">
											...
											<div class="col-md-3 rf-bl animateblock right1">
												  <div class="rf-bl-pic">
													<!-- <a href="products/<?php echo $recent_product_details->row($i)->product_seourl; ?>"><img src="images/product/<?php echo $img[0]; ?>" alt="recent"> </a> -->
													<a href="products/<?php echo $recent_product_details->row($i)->product_seourl; ?>"><img src="images/product/cropmed/<?php echo $img[0]; ?>" alt="recent"> </a>
													<?php
													...
													$price=$recent_product_details->row($i)->price; $pls=''; 
													        $offer=($recent_product_details->row($i)->discount/100)*$price;
													} else{ 
													$price=$recent_product_details->row($i)->base_price; $pls='+'; 
													        $offer=($recent_product_details->row($i)->discount/100)*$price;
													} 
													      $dealprice=$price-$offer;
													...
													<?php }} ?>
												          ...
												          <span class="cat-name">
													<a href="products/<?php echo $recent_product_details->row($i)->product_seourl; ?>"><?php echo character_limiter($recent_product_details->row($i)->product_name,25); ?></a>
												  </span> 
												...
												$price=$recent_product_details->row($i)->base_price; $pls='+'; 
												  ...
												  <div class="recent-bl">
													...
													<img src="images/<?php echo $profile_pic?>" alt="<?php echo $recent_product_details->row($i)->full_name; ?>" width="55px" class="img-circle" >
													            <div class="recent-right" >
														<p ><?php if($this->lang->line('user_from') != '') { echo stripslashes($this->lang->line('user_from')); } else echo 'From'; ?> -  <a href="shop-section/<?php echo $recent_product_details->row($i)->seourl?>"> <?php echo $recent_product_details->row($i)->full_name; ?></a>
													                </p>
													<div   class="rating-input rating readonly-rating" data-score="<?php echo number_format($recent_product_details->row($i)->shop_ratting,2); ?>" ></div>
													<span class="review-txt"> <?php echo $recent_product_details->row($i)->review_count; ?> <?php if($this->lang->line('shopsec_reviews') != '') { echo stripslashes($this->lang->line('shopsec_reviews')); } else echo "Reviews"; ?></span>
												              </div>
											          </div>
											         
										        </div>
										
										<?php if(($i+1)%4 == 0 || ($i+1) == count($recent_product_details->result())){ ?>
									</div>
									<?php } ?>
					...
					<?php if($FavShops[0]!=$testiMoni->seller_id && $testiMoni->seller_banner!=''){ ?>
					<section class="testimonial-img"> 
						<img src="images/banner/<?php echo $testiMoni->seller_banner; ?>" alt="<?php echo $testiMoni->user_name; ?>" >
						  <div class="testimonial-block container">
							<div class="testi-in col-md-10"> 
								<span class="testi"> 
									
									<?php if($testiMoni->thumbnail!=''){
									$tuser_pic='users/thumb/'.$testiMoni->thumbnail; 
									}else{ 
									$tuser_pic='default_avat.png';
									} ?>
									
									<!--<a href="view-profile/<?php echo $testiMoni->user_name; ?>"> -->
									<img src="images/<?php echo $tuser_pic;?>" alt<?php echo $testiMoni->user_name; ?> class="img-circle  ct-clock-img">
									<!--</a>-->
								</span>
								<h3><a href="<?php echo base_url().'blog/'.$testiMoni->post_name; ?>"  target="_blank"><?php echo $testiMoni->post_title; ?></a> </h3>
								     <span class="owner-details">
									 <em>Meet</em>
									<a class="shop-name" href="shop-section/<?php echo $testiMoni->shopurl; ?>">
										<span class="user-name"><?php echo $testiMoni->full_name; ?></span> of <?php echo $testiMoni->shopname; ?>
									</a>
									 <em>in</em> 
									<span class="location"><?php if($testiMoni->city != ''){echo $testiMoni->city.',';} echo $testiMoni->country; ?></span>
								 </span> 
							</div>
						  </div>
					</section>
					...
					<section class="second-bl" style="padding-bottom:0;">
						  <div class="container">
							...
							<?php echo stripslashes($this->config->item('landing_widget1')); ?>
							  
							    <div class="col-md-12 get-pro">  
								<?php if($this->lang->line('land_trends') != '') { echo stripslashes($this->lang->line('land_trends')); } else echo "Get top trends and fresh editors' picks"; ?><br>
								<?php if($this->lang->line('land_inbox') != '') { echo stripslashes($this->lang->line('land_inbox')); } else echo "in your inbox with"; ?> <br> <?php echo $this->config->item('email_title'); ?>
								<?php if($this->lang->line('user_finds') != '') { echo stripslashes($this->lang->line('user_finds')); } else echo "Finds"; ?>.
								  
								  <span class="subcribe-box ">
									  
									  <form method="post" class="subscribe-form" action="site/user/subscribeUser">
										<input type="text" placeholder="<?php if($this->lang->line('land_email') != '') { echo stripslashes($this->lang->line('land_email')); } else echo 'Enter Your E-mail address'; ?>"  name="emaill" id="emailtext">
										<input type="submit" value="<?php if($this->lang->line('landing_subscribe') != '') { echo stripslashes($this->lang->line('landing_subscribe')); } else echo 'Subscribe'; ?>" onClick="return subscribe_user();"class="search-bt">	<br/>
