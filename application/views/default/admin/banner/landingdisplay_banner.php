				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						<tr>
							...
							<td class="center">
								<img src="images/landingbanner/<?php echo $row->image;?>" width="100"/>
							</td>
							<?php /*?><td class="center">
								<?php echo $row->link;?>
							</td><?php */?>
							...
							if ($allPrev == '1' || in_array('2', $banner)){
								...
								if ($mode == '0'){
							?>
								<a title="Click to unpublish" class="tip_top" href="javascript:confirm_status('admin/landing_banner/change_landingbanner_status/<?php echo $mode;?>/<?php echo $row->id;?>');"><span class="badge_style b_done"><?php echo $row->status;?></span></a>
							<?php
								}else {	
							?>
								<a title="Click to publish" class="tip_top" href="javascript:confirm_status('admin/landing_banner/change_landingbanner_status/<?php echo $mode;?>/<?php echo $row->id;?>')"><span class="badge_style"><?php echo $row->status;?></span></a>
							<?php 
								}
							}else {
							?>
							...
							<td class="center">
							<?php //if ($allPrev == '1' || in_array('2', $banner)){?>
								<span><a class="action-icons c-edit" href="admin/landing_banner/landingedit_banner/<?php echo $row->id;?>" title="Edit">Edit</a></span>
							<?php// }?>
							<?php// if ($allPrev == '1' || in_array('3', $banner)){?>	
								<span><a class="action-icons c-delete" href="javascript:confirm_delete('admin/landing_banner/landingdelete_banner/<?php echo $row->id;?>')" title="Delete">Delete</a></span>
							<?php //} ?>
							</td>
						</tr>
						<?php 
