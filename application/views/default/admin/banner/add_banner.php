	 						...
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										...
										<span id="msg_size" class="input_instruction green">Image Size 650 x 450 pixel</span>
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									<div class="form_input">
										<button type="submit" class="btn_small btn_blue" onclick="return check_img();"  tabindex="5"><span>Submit</span></button>
									</div>
								</div>
								</li>
							</ul>
