...
<!--                             <th class="tip_top" title="Click to sort">
 ...
 -->							<th class="tip_top" title="Click to sort">
						...
						<input  id="product_name" type="hidden" value="<?php echo $row->product_name;?>">
							...
							<td class="center">
							<a style="position:relative;"  href="javascript:void(0)" id="<?php echo $row->id;?>" name="product_featured" onclick ="change_featured_product(this);" >Feature</a>
						...
						<div class="conversation_container">
							<h2 class="conversation_headline" style="margin: 8px;color: #9E612F;"> Pick The Package And Date </h2>													
								<form action ="admin/product/change_featuredproduct_ajax" id="featured_date" method="get">
									...
									<div class="table-new-1">
										<table class="table-new-2">
											...
											<tr>
												...
												<td width="150px"><?php echo artfill_lg('lg_name','Name');?></td>
									...
									<br><table><tr><td>page</td><td width="306px"> <input type="radio" class="required small tipTop" title="Please select the Page"  name="Page" id="Page" value="home">Home page</td></tr>
										 <tr><td></td><td><input type="radio" class="required small tipTop" title="Please select the Page"  name="Page" id="Page" value="search">Search page</td></tr>
										  <tr><td></td><td><input type="radio" class="required small tipTop" title="Please select the Page"  name="Page" id="Page" value="product detail">Product Detail page</td></tr></table>
