						...
						<li>
							<div class="form_grid_12">
								...
								<div class="form_input">
									<input name="sitemap_file" id="sitemap_file" type="file" tabindex="2" class="large tipTop required" title="Please upload banner image" accept="xml"/>
									<span class="input_instruction red">To create a sitemap for below link and upload the sitemap.xml file.<br><a href="https://xmlsitemapgenerator.org/" target="_blank">https://xmlsitemapgenerator.org/</a></span>
								</div>
							</div>
						</li>
