			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<?php 
						...
						echo form_open_multipart('admin/layout/insettheme_data',$attributes) 
					?>
	 						<ul>
	 							<li>
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="theme_name" id="full_name" type="text" tabindex="1" class="required large tipTop" title="Please enter the Theme name"/>
									</div>
								</div>
								</li>
