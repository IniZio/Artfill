						...
						<ul>
                           ...
                           <!-- <li>
                            ...
                            <?php }?>
							 ...
							 <li>
								...
								?>
                            		  ...
                            		  <li>
								<div class="form_grid_12">
								<label class="field_title" for="sku">Deal date</label>
								<div class="form_input">
								<?php 
								if ($product_details->row()->deal_date != ''){
									echo $product_details->row()->deal_date;
								}else {
									echo 'Not available';
								}
								?>
									  ...
									  <li>
								<div class="form_grid_12">
								<label class="field_title" for="sku">Deal time</label>
								<div class="form_input">
								<?php 
								if ($product_details->row()->deal_time_from != ''){
									echo $product_details->row()->deal_time_from;
								}else {
									echo 'Not available';
								}
								?>
								to
								<?php 
								if ($product_details->row()->deal_time_to != ''){
									echo $product_details->row()->deal_time_to;
								}else {
									echo 'Not available';
								}
								?>
									  ...
									  <li>
								<div class="form_grid_12">
								<label class="field_title" for="sku">Discount</label>
								<div class="form_input">
								<?php 
								if ($product_details->row()->discount != ''){
									echo $product_details->row()->discount.'%';
								}else {
									echo 'Not available';
								}
								?>
                            ...
                            <!-- <li>
								...
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/deals/display_deal_lists" class="tipLeft" title="Go to Deals list"><span class="badge_style b_done">Back</span></a>
									</div>
								</div>
								</li>
							</ul>
						...
						//	            if ($options != '' && is_array($attNameArr) && count($attNameArr)>0){
							            ...
							            <table class="wtbl_list">
							            	...
							            	<tr>
							            		...
							            		<td><?php echo $ship->ship_cost;?></td>
                                                <td><?php echo $ship->ship_other_cost;?></td>
							            	</tr>
							            	<?php }?>
							            </table>
							            <?php 	
									...
									<a href="admin/deals/display_deal_lists" class="tipLeft" title="Go to Deal list"><span class="badge_style b_done">Back</span></a>
                      </li>
