                ...
                <li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
                      <input name="post_title" id="post_title" type="text" value="" tabindex="2" class="required large tipTop" title="Please enter the page name"/>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
                      <textarea name="post_content" tabindex="4" class="large tipTop mceEditor" title="Please enter the page content"></textarea>
                    </div>
                  </div>
                </li>
              </ul>
              ...
              <ul>
                <li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
                      <input name="seo_title" id="seo_title" type="text" value="" tabindex="1" class="large tipTop" title="Please enter the page meta title"/>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
                      <input name="seo_keyword" id="seo_keyword" type="text" value="" tabindex="2" class="large tipTop" title="Please enter the page meta tag"/>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
                      <textarea name="seo_description" id="seo_description" tabindex="3" class="large tipTop" title="Please enter the meta description"></textarea>
                    </div>
                  </div>
                </li>
              </ul>
