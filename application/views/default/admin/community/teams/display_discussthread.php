					...
					<div class="widget_content">
						...
						<tr>
                            ...
                            <td class="center">
 							...
 							<td class="center">
							<?php echo character_limiter(stripslashes($details['post']), 30);?>
							</td>
							...
							if ($allPrev == '1' || in_array('2', $community)){
								...
								$modeViewDisplay = ($details['status'] == 'Active')?'Active':'Unpublish';
								if ($mode == '0'){
							?>
								<a title="Click to unpublish" class="tip_top" href="javascript:confirm_status('admin/community/change_discussthrd_status/<?php echo $mode;?>/<?php echo $details['id'];?>/<?php echo $details['rootId']; ?>');"><span class="badge_style b_done"><?php echo $modeViewDisplay;?></span></a>
							<?php
								}else {	
							?>
								<a title="Click to publish" class="tip_top" href="javascript:confirm_status('admin/community/change_discussthrd_status/<?php echo $mode;?>/<?php echo $details['id'];?>/<?php echo $details['rootId']; ?>')"><span class="badge_style"><?php echo $modeViewDisplay;?></span></a>
							<?php 
								}
							}else {
							?>
							...
							<?php if ($allPrev == '1' || in_array('3', $community)){?>	
								<span><a class="action-icons c-delete" href="javascript:confirm_delete('admin/community/delete_discussthrd/<?php echo $details['id'];?>/<?php echo $details['rootId']; ?>')" title="Delete">Delete</a></span>
							<?php }?>
							</td>
						</tr>
						<?php 
