					...
					<div class="widget_content">
						...
						<tr>
							...
							if ($allPrev == '1' || in_array('2', $banner)){
								...
								if ($mode == '0'){
							?>
								<a title="Click to unpublish" class="tip_top" href="javascript:confirm_status('admin/banner/change_banner_status/<?php echo $mode;?>/<?php echo $row->id;?>');"><span class="badge_style b_done"><?php echo $row->status;?></span></a>
							<?php
								}else {	
							?>
							...
							<td class="center">
							<?php if ($allPrev == '1' || in_array('2', $banner)){?>
								<span><a class="action-icons c-edit" href="admin/banner/edit_banner/<?php echo $row->id;?>" title="Edit">Edit</a></span>
							<?php }?>
							<?php if ($allPrev == '1' || in_array('3', $banner)){?>	
								<span><a class="action-icons c-delete" href="javascript:confirm_delete('admin/banner/delete_banner/<?php echo $row->id;?>')" title="Delete">Delete</a></span>
							<?php } ?>
							</td>
						</tr>
						<?php 
