			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Complaints About "<?php echo $spamList->row()->product_name;?>"</h6>
					...
					<div class="widget_content">
						...
						<tr>
							...
							<?php }?>-->
								<span><a class="action-icons c-suspend" href="admin/spam/view_product_spam_reply/<?php echo $row->spam_id;?>" title="View">View</a></span>
							...
							?>
								...
								<span><a class="action-icons c-delete" href="javascript:confirm_delete('admin/spam/delete_product_spam_record/<?php echo $row->spam_id;?>/<?php echo $this->uri->segment(4);?>')" title="Delete">Delete</a></span>
							<?php } }?>
							</td>
						</tr>
						<?php 
