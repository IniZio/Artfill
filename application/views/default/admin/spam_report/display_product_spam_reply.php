					...
					?>
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div  class="form_input"> <?php $imG=explode(',',$spamList->image);?>
										<?php if($imG[0] != '') {?><img src="images/product/thumb/<?php echo $imG[0];?>" style="width:170px; height:135px;background-color: #FFFFFF;
border: 1px solid #ECECEC;" />
									<?php } else {?><img src="images/dummyProductImage.jpg" style="width:170px; height:135px;background-color: #FFFFFF;
border: 1px solid #ECECEC;" /> <?php }?>
                                   <br /><span><b>Product Name : </b><?php echo $spamList->product_name;?></span> <br />
                                   <span><b>Product Status : </b><?php echo $spamList->status;?></span>
                                    </div>
...
border: 1px solid #ECECEC;" />        <br />	 <spam><b>Name : </b><?php echo $spamList->reporter_name;?></spam> <br />	
										<spam><b>Email : </b><?php echo $spamList->reporter_email;?></spam>
									</div>
								</div>
								</li>
                               ...
                               <li>
								...
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/spam/spam_product_List" class="tipLeft" title="Go to lists"><span class="badge_style b_done">Back</span></a>
