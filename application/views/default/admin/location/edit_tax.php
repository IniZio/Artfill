			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<?php 
						...
						echo form_open('admin/location/insertEditState',$attributes) 
					?> 		
                    	<div id="tab1">
	 						<ul>
                            	<li>
                                  <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                      <select class="chzn-select required" name="country_id" tabindex="-1" style="width: 375px; display: none;" data-placeholder="Please select the country name">
											...
											?>
                                            <option value="<?php echo $countryrow['id'];?>" <?php if($tax_details->row()->countryid==$countryrow['id']){echo 'selected=""';} ?> ><?php echo $countryrow['name'];?></option>
                                            <?php }?>
                                      </select>
                                    </div>
                                  </div>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input name="name" style=" width:295px" id="state_name" value="<?php echo $tax_details->row()->name;?>" type="text" tabindex="1" class="required tipTop" title="Please enter the state name"/>
									</div>
								</div>
								</li>
								<li>
