					...
					<div class="widget_top">
                        ...
                        <div id="widget_tab">
              				<ul>
               					 ...
               					 <?php /* ?><li><a href="#tab2">SEO</a></li><?php */ ?>
             				 </ul>
            			</div>
					</div>
                    	...
                    	<div id="tab1">
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input name="name" style=" width:295px" id="state_name" value="" type="text" tabindex="1" class="required tipTop" title="Please enter the state name"/>
									</div>
								</div>
								</li>
								<li>
