...
class USPSRate extends USPSBase {
 ...
 protected $apiVersion = 'RateV4';
  //protected $apiVersion = 'IntlRateV2';
  /**
  ...
  public function addPackage(USPSRatePackage $data, $id=null) {
	//$this->packages['Revision'] = 2;
	//$this->packages['RateClientType'] ='008';
...
class USPSRatePackage extends USPSRate {
  ...
  public function ArraysetField($field,$key, $value) {
    $this->packageInfo[$field][ ucwords($key) ] = $value;
    return $this;
  }
  /**
