...
if((in_array('collection', $pickupArr)) && (in_array('delivery', $pickupArr))){
    ...
    <option value="2">香港大學</option>
    <option value="3">西營盤</option>
    <option value="4">上環</option>
    <option value="5">中環</option>
    <option value="6">金鐘</option>
    <option value="7">灣仔</option>
    <option value="8">銅鑼灣</option>
    <option value="9">天后</option>
    <option value="10">炮台山</option>
    <option value="11">北角</option>
    <option value="12">鰂魚涌</option>
    <option value="13">太古</option>
    <option value="14">西灣河</option>
    <option value="15">筲箕灣</option>
    <option value="16">杏花邨</option>
    <option value="17">柴灣</option>
    <option value="">-- 觀塘綫 --</option>
    <option value="18">油麻地</option>
    <option value="19">旺角</option>
    <option value="20">太子</option>
    <option value="21">石硤尾</option>
    <option value="22">九龍塘</option>
    <option value="23">樂富</option>
    <option value="24">黃大仙</option>
    <option value="25">鑽石山</option>
    <option value="26">彩虹</option>
    <option value="27">九龍灣</option>
    <option value="28">牛頭角</option>
    <option value="29">觀塘</option>
    <option value="30">藍田</option>
    <option value="31">油塘</option>
    <option value="32">調景嶺</option>
    <option value="">-- 荃灣綫 --</option>
    <option value="33">中環</option>
    <option value="34">金鐘</option>
    <option value="35">尖沙咀</option>
    <option value="36">佐敦</option>
    <option value="37">油麻地</option>
    <option value="38">旺角</option>
    <option value="39">太子</option>
    <option value="40">深水埗</option>
    <option value="41">長沙灣</option>
    <option value="42">荔枝角</option>
    <option value="43">美孚</option>
    <option value="44">荔景</option>
    <option value="45">葵芳</option>
    <option value="46">葵興</option>
    <option value="47">大窩口</option>
    <option value="48">荃灣</option>
    <option value="">-- 將軍澳綫 --</option>
    <option value="49">北角</option>
    <option value="50">鰂魚涌</option>
    <option value="51">油塘</option>
    <option value="52">調景嶺</option>
    <option value="53">將軍澳</option>
    <option value="54">坑口</option>
    <option value="55">寶琳</option>
    <option value="56">康城</option>
    <option value="">-- 東涌綫 --</option>
    <option value="57">香港</option>
    <option value="58">九龍</option>
    <option value="59">奧運</option>
    <option value="60">南昌</option>
    <option value="61">荔景</option>
    <option value="62">青衣</option>
    <option value="63">東涌</option>
    <option value="64">欣澳</option>
    <option value="">-- 東鐵綫 --</option>
    <option value="65">紅磡</option>
    <option value="66">旺角東</option>
    <option value="67">九龍塘</option>
    <option value="68">大圍</option>
    <option value="69">沙田</option>
    <option value="70">火炭</option>
    <option value="71">大學</option>
    <option value="72">大埔墟</option>
    <option value="73">太和</option>
    <option value="74">粉嶺</option>
    <option value="75">上水</option>
    <option value="">-- 馬鞍山綫 --</option>
    <option value="76">大圍</option>
    <option value="77">車公廟</option>
    <option value="78">沙田圍</option>
    <option value="79">第一城</option>
    <option value="80">石門</option>
    <option value="81">大水坑</option>
    <option value="82">恆安</option>
    <option value="83">馬鞍山</option>
    <option value="84">烏溪沙</option>
    <option value="">-- 西鐵綫 --</option>
    <option value="65">紅磡</option>
    <option value="86">尖東</option>
    <option value="87">柯士甸</option>
    <option value="88">南昌</option>
    <option value="89">美孚</option>
    <option value="90">荃灣西</option>
    <option value="91">錦上路</option>
    <option value="92">元朗</option>
    <option value="93">朗屏</option>
    <option value="94">天水圍</option>
    <option value="95">兆康</option>
    <option value="96">屯門</option>';
