...
--
-- Dumping data for table `artfill_user`
--

insert into `artfill_user`(is_local_account, first_name, last_name, user_name, email) values ('Yes', 'chris', 'wong', 'adom', 'digit4free@gmail.com');
