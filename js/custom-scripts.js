	  ...
	  messages: {
		  full_name: {
			...
			new_password: {
				...
				maxlength: "Password must consist of less than 12 characters"
			},
			confirm_password: {
	  ...
	  messages: {
	       title: {
			...
			description: {
				...
				minlength: "slider description  must consist of at least 10 characters"
			},
...
//		                 "aaSorting": [[0, 'desc']],
	...
	$('#questiontoseller_tbl').dataTable({   
		 "aoColumnDefs": [
	...
	$('#subadmin_tbl').dataTable({   
		...
		"oLanguage": {
		 ...
		 "sDom": '<"table_top"fl<"clear">>,<"table_content"t>,<"table_bottom"p<"clear">>'
			...
			$('#display_product_tbl').dataTable({   
		 "aoColumnDefs": [
							{ "bSortable": false, "aTargets": [ 1,0 , 9 ] }
						],
						"aaSorting": [[8, 'desc']],
		"sPaginationType": "full_numbers",
		"iDisplayLength": 50,
