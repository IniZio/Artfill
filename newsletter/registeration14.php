...
<tbody>
<tr>
<td style=\"padding: 10px 0px; color: #5a5a5a; font-size: 15px;\">Hi there '.$userName.',</td>
</tr>
<tr>
<td style=\"padding: 6px 0px; color: #5a5a5a; font-size: 15px;\">We received your request to reopen your account, Here\'s what you need to do:</td>
</tr>
<tr>
<td style=\"padding: 10px 0px; color: #5a5a5a; font-size: 15px;\">1. Click the button below to confirm your identity.</td>
</tr>
<tr>
<td style=\"text-align: center; padding: 20px 0;\"><a style=\"background: #34a8c4; border-bottom: 3px solid #047894; border-radius: 3px; padding: 5px 10px; color: #fff; font-weight: bold; text-decoration: none;\" href=\"'.$cfmurl.'\">Reopen Your Account</a></td>
</tr>
<tr>
<td style=\"padding: 10px 0px; color: #5a5a5a; font-size: 15px;\">If you did not request to have your '.$email_title.' reopen account recently, please                                 <a href=\"'.base_url().'pages/contact-us\">Contact Support</a></td>
</tr>
<tr>
