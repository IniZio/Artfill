...
<tr>
<td style=\"padding: 10px 0px; color: #5a5a5a; font-size: 15px;\">Your '.$email_title.' account has been reopened. And we have changed your password for security purpose please use new password.</td>
</tr>
<tr>
<td style=\"text-align: center; padding: 20px 0;\">Your New Password <strong>'.$pwd.' </strong></td>
</tr>
<tr>
