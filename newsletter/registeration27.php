...
<tbody>
<tr>
<td style=\"padding: 10px 0px; color: #5a5a5a; font-size: 15px;\">Hi '.$mailName.',</td>
</tr>
<tr>
<td style=\"padding: 6px 0px; color: #5a5a5a; font-size: 15px;\">'.$userrname.' wants to remove his/her bid on your auction.</td>
</tr>
<tr>
<td style=\"padding: 6px 0px; color: #5a5a5a; font-size: 15px;\">User Id: '.$muserID.'</td>
</tr>
<tr>
<td style=\"padding: 10px 0px; color: #5a5a5a; font-size: 15px;\">Click below &nbsp;link to see the auction informations,<br /><a href=\"'.$mailLink.'\">'.$mailLink.'</a></td>
</tr>
<tr>
