...
$sApplicationId = '528096587268434';
$sApplicationSecret = '2b08021d7ce053cc36fa8d1f3b06253c';
$iLimit = 99;
            ...
            function updateButton(response) {
                ...
                if (response.authResponse) { // in case if we are logged in
                    ...
                    FB.api('/me', function(response) {
                        userInfo.innerHTML = '<img src="https://graph.facebook.com/' + response.id + '/picture">' + response.name + response.email;
